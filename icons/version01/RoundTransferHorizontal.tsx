...
const IconRoundTransferHorizontal: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconRoundTransferHorizontal as IconComponentType).keywords = [
  "round",
  "transfer",
  "horizontal",
  "orbicular",
...
export default IconRoundTransferHorizontal as IconComponentType;
