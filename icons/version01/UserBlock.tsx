...
const IconUserBlock: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          ...
          <path
            ...
            d="M15.5 13.5356C14.4704 13.1953 13.275 13.0005 12 13.0005C8.13401 13.0005 5 14.7913 5 17.0005C5 19.2096 5 21.0005 12 21.0005C12.3506 21.0005 12.6836 20.996 13 20.9872"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
          <path
            d="M19.9502 17.0503L16.0502 20.9502"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M18 15.7505C16.2051 15.7505 14.75 17.2056 14.75 19.0005C14.75 20.7954 16.2051 22.2505 18 22.2505C19.7949 22.2505 21.25 20.7954 21.25 19.0005C21.25 17.2056 19.7949 15.7505 18 15.7505ZM16.25 19.0005C16.25 18.034 17.0335 17.2505 18 17.2505C18.2063 17.2505 18.4043 17.2862 18.5881 17.3518L16.3513 19.5886C16.2857 19.4048 16.25 19.2068 16.25 19.0005ZM17.4119 20.6492L19.6487 18.4124C19.7143 18.5962 19.75 18.7942 19.75 19.0005C19.75 19.967 18.9665 20.7505 18 20.7505C17.7937 20.7505 17.5957 20.7148 17.4119 20.6492Z"
            fill="currentColor"
          />
          <path
            d="M12 22.0005C4 22.0005 4 19.9858 4 17.5005C4 15.0152 7.58172 13.0005 12 13.0005C14.3695 13.0005 16.4983 13.5799 17.9632 14.5006C15.4949 14.5204 13.5 16.5275 13.5 19.0005C13.5 20.112 13.903 21.1293 14.5708 21.9144C13.8219 21.9709 12.9697 22.0005 12 22.0005Z"
            fill="currentColor"
          />
        </svg>
      )}
...
(IconUserBlock as IconComponentType).keywords = [
  "user",
  "block",
  "exploiter",
  "enjoyer",
...
export default IconUserBlock as IconComponentType;
