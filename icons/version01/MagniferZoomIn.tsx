...
(IconMagniferZoomIn as IconComponentType).keywords = [
  "magnifer",
  "zoom",
  "in",
  "whizz",
...
export default IconMagniferZoomIn as IconComponentType;
