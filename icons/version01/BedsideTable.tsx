...
const IconBedsideTable: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M13 11.0001C13 11.5524 12.5523 12.0001 12 12.0001C11.4477 12.0001 11 11.5524 11 11.0001C11 10.4478 11.4477 10.0001 12 10.0001C12.5523 10.0001 13 10.4478 13 11.0001Z"
            fill="currentColor"
          />
          <path
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M21.9743 7.25012H2.02572C2.09185 5.22894 2.32803 4.01524 3.17157 3.17169C4.34315 2.00012 6.22876 2.00012 10 2.00012H14C17.7712 2.00012 19.6569 2.00012 20.8284 3.17169C21.672 4.01524 21.9082 5.22894 21.9743 7.25012ZM13 5.00012C13 5.55241 12.5523 6.00012 12 6.00012C11.4477 6.00012 11 5.55241 11 5.00012C11 4.44784 11.4477 4.00012 12 4.00012C12.5523 4.00012 13 4.44784 13 5.00012Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M2 10.0001C2 9.55819 2 9.14215 2.00189 8.75012H21.9981C22 9.14215 22 9.55819 22 10.0001V12.0001C22 12.4421 22 12.8581 21.9981 13.2501H2.00189C2 12.8581 2 12.4421 2 12.0001V10.0001ZM12 12.0001C12.5523 12.0001 13 11.5524 13 11.0001C13 10.4478 12.5523 10.0001 12 10.0001C11.4477 10.0001 11 10.4478 11 11.0001C11 11.5524 11.4477 12.0001 12 12.0001Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
...
(IconBedsideTable as IconComponentType).keywords = [
  "bedside",
  "table",
  "bed",
  "bunk",
...
export default IconBedsideTable as IconComponentType;
