    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M18.416 15.876C18.7607 16.1058 18.8538 16.5715 18.624 16.9161L18.4014 17.2501H19C19.2766 17.2501 19.5307 17.4023 19.6613 17.6462C19.7918 17.8901 19.7775 18.186 19.624 18.4161L18.624 19.9161C18.3943 20.2608 17.9286 20.3539 17.584 20.1241C17.2393 19.8944 17.1462 19.4287 17.376 19.0841L17.5986 18.7501H17C16.7234 18.7501 16.4693 18.5978 16.3387 18.354C16.2082 18.1101 16.2225 17.8142 16.376 17.5841L17.376 16.0841C17.6057 15.7394 18.0714 15.6463 18.416 15.876Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M18 22C20.2091 22 22 20.2091 22 18C22 15.7909 20.2091 14 18 14C15.7909 14 14 15.7909 14 18C14 20.2091 15.7909 22 18 22ZM18.416 15.876C18.7607 16.1057 18.8538 16.5714 18.624 16.916L18.4014 17.25H19C19.2766 17.25 19.5307 17.4022 19.6613 17.6461C19.7918 17.89 19.7775 18.1859 19.624 18.416L18.624 19.916C18.3943 20.2607 17.9286 20.3538 17.584 20.124C17.2393 19.8943 17.1462 19.4286 17.376 19.084L17.5986 18.75H17C16.7234 18.75 16.4693 18.5978 16.3387 18.3539C16.2082 18.11 16.2225 17.8141 16.376 17.584L17.376 16.084C17.6057 15.7393 18.0714 15.6462 18.416 15.876Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
...
(IconAirbudsCharge as IconComponentType).keywords = [
  "airbuds",
  "charge",
  "consign",
  "commission",
...
export default IconAirbudsCharge as IconComponentType;
