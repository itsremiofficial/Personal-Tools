    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M5.5 9.25037C5.08579 9.25037 4.75 9.58615 4.75 10.0004C4.75 10.4146 5.08579 10.7504 5.5 10.7504H11.5C11.9142 10.7504 12.25 10.4146 12.25 10.0004C12.25 9.58615 11.9142 9.25037 11.5 9.25037H5.5Z"
            fill="currentColor"
          />
          <path
            d="M6.5 13.2504C6.08579 13.2504 5.75 13.5862 5.75 14.0004C5.75 14.4146 6.08579 14.7504 6.5 14.7504H10.5C10.9142 14.7504 11.25 14.4146 11.25 14.0004C11.25 13.5862 10.9142 13.2504 10.5 13.2504H6.5Z"
            fill="currentColor"
          />
          <path
        ...
        >
          <path
            d="M22 11.0004V13.0004C22 16.7716 22 18.6572 20.8284 19.8288C19.8541 20.8031 18.3859 20.9672 15.75 20.9948V3.00596C18.3859 3.03357 19.8541 3.19761 20.8284 4.17194C22 5.34351 22 7.22913 22 11.0004Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M10 3.00037H14H14.25L14.25 21.0004H14H10C6.22876 21.0004 4.34315 21.0004 3.17157 19.8288C2 18.6572 2 16.7716 2 13.0004V11.0004C2 7.22913 2 5.34351 3.17157 4.17194C4.34315 3.00037 6.22876 3.00037 10 3.00037ZM4.75 10.0004C4.75 9.58615 5.08579 9.25037 5.5 9.25037H11.5C11.9142 9.25037 12.25 9.58615 12.25 10.0004C12.25 10.4146 11.9142 10.7504 11.5 10.7504H5.5C5.08579 10.7504 4.75 10.4146 4.75 10.0004ZM5.75 14.0004C5.75 13.5862 6.08579 13.2504 6.5 13.2504H10.5C10.9142 13.2504 11.25 13.5862 11.25 14.0004C11.25 14.4146 10.9142 14.7504 10.5 14.7504H6.5C6.08579 14.7504 5.75 14.4146 5.75 14.0004Z"
            fill="currentColor"
          />
        </svg>
      )}
...
(IconSiderbar as IconComponentType).keywords = ["siderbar"];

export default IconSiderbar as IconComponentType;
