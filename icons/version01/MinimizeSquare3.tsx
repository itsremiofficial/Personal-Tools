...
const IconMinimizeSquare3: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconMinimizeSquare3 as IconComponentType).keywords = [
  "minimize",
  "square",
  "3",
  "derogate",
...
export default IconMinimizeSquare3 as IconComponentType;
