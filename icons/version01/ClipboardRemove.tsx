    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M14.5 11.0004L9.50004 16.0004M9.50002 11.0004L14.5 16.0004"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8.96967 10.47C9.26256 10.1771 9.73744 10.1771 10.0303 10.47L12 12.4397L13.9697 10.4701C14.2626 10.1772 14.7374 10.1772 15.0303 10.4701C15.3232 10.7629 15.3232 11.2378 15.0303 11.5307L13.0607 13.5004L15.0303 15.47C15.3232 15.7629 15.3232 16.2378 15.0303 16.5307C14.7374 16.8236 14.2625 16.8236 13.9696 16.5307L12 14.561L10.0304 16.5307C9.73746 16.8236 9.26258 16.8236 8.96969 16.5307C8.6768 16.2378 8.6768 15.7629 8.96969 15.47L10.9393 13.5004L8.96967 11.5307C8.67678 11.2378 8.67678 10.7629 8.96967 10.47Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconClipboardRemove as IconComponentType).keywords = [
  "clipboard",
  "remove",
  "flipchart",
  "notebook",
...
export default IconClipboardRemove as IconComponentType;
