  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M9.72104 20.0005H12.358C14.5854 20.0005 15.6992 20.0005 16.6289 19.4677C17.5586 18.9349 18.1488 17.9585 19.3294 16.0055L20.0102 14.8792C21.0034 13.2362 21.5 12.4147 21.5 11.5005C21.5 10.5863 21.0034 9.7648 20.0102 8.12174L19.3294 6.9955C18.1488 5.04252 17.5586 4.06603 16.6289 3.53326C15.6992 3.00049 14.5854 3.00049 12.358 3.00049H9.72104C5.84561 3.00049 3.90789 3.00049 2.70394 4.24528C1.5 5.49008 1.5 7.49355 1.5 11.5005C1.5 15.5074 1.5 17.5109 2.70394 18.7557C3.90789 20.0005 5.8456 20.0005 9.72104 20.0005Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
...
(IconTagHorizontal as IconComponentType).keywords = [
  "tag",
  "horizontal",
  "label",
  "mark",
...
export default IconTagHorizontal as IconComponentType;
