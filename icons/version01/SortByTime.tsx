    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M17 10.0002V11.8464L18 13.0002"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
        ...
        >
          ...
          <g opacity={duotone ? "0.5" : "1"}>
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M1.25 7.00024C1.25 6.58603 1.58579 6.25024 2 6.25024H10C10.4142 6.25024 10.75 6.58603 10.75 7.00024C10.75 7.41446 10.4142 7.75024 10 7.75024H2C1.58579 7.75024 1.25 7.41446 1.25 7.00024ZM1.25 12.0002C1.25 11.586 1.58579 11.2502 2 11.2502H8C8.41421 11.2502 8.75 11.586 8.75 12.0002C8.75 12.4145 8.41421 12.7502 8 12.7502H2C1.58579 12.7502 1.25 12.4145 1.25 12.0002ZM1.25 17.0002C1.25 16.586 1.58579 16.2502 2 16.2502H10C10.4142 16.2502 10.75 16.586 10.75 17.0002C10.75 17.4145 10.4142 17.7502 10 17.7502H2C1.58579 17.7502 1.25 17.4145 1.25 17.0002Z"
              fill="currentColor"
            />
          </g>
        </svg>
...
(IconSortByTime as IconComponentType).keywords = [
  "sort",
  "by",
  "time",
  "classify",
...
export default IconSortByTime as IconComponentType;
