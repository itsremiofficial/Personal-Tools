      ...
      {!fill ? (
        ...
        >
          <path
            ...
            fillRule="evenodd"
            clipRule="evenodd"
            d="M3.17157 4.17197C2 5.34354 2 7.22916 2 11.0004V13.0004C2 16.7716 2 18.6573 3.17157 19.8288C4.34315 21.0004 6.22876 21.0004 10 21.0004H14C14.0843 21.0004 14.9176 21.0004 15 21.0004L15 3.00043C14.9176 3.00041 14.0843 3.0004 14 3.0004H10C6.22876 3.0004 4.34315 3.0004 3.17157 4.17197Z"
            fill="currentColor"
          />
          <path
...
(IconSidebarMinimalistic as IconComponentType).keywords = [
  "sidebar",
  "minimalistic",
  "billet",
  "margin",
...
export default IconSidebarMinimalistic as IconComponentType;
