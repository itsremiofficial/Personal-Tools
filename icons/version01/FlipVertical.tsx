...
const IconFlipVertical: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconFlipVertical as IconComponentType).keywords = [
  "flip",
  "vertical",
  "flip over",
  "toss",
...
export default IconFlipVertical as IconComponentType;
