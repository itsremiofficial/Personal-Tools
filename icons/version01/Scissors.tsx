    ...
    <>
      {!fill ? (
        ...
        >
          <path
            opacity={duotone ? "0.5" : "1"}
            d="M6.65389 1.63257C6.45089 1.27151 5.99363 1.14338 5.63257 1.34638C5.27151 1.54938 5.14338 2.00664 5.34638 2.3677L15.7041 20.7901C16.3395 21.9577 17.5773 22.7501 19.0001 22.7501C21.0712 22.7501 22.7501 21.0712 22.7501 19.0001C22.7501 16.9291 21.0712 15.2501 19.0001 15.2501C17.4674 15.2501 16.1495 16.1697 15.5679 17.4871L6.65389 1.63257Z"
            fill="currentColor"
          />
          <path
            d="M17.3461 1.63257C17.5491 1.27151 18.0064 1.14338 18.3674 1.34638C18.7285 1.54938 18.8566 2.00664 18.6536 2.3677L8.29594 20.7901C7.66052 21.9577 6.42274 22.7501 4.99988 22.7501C2.92881 22.7501 1.24988 21.0712 1.24988 19.0001C1.24988 16.9291 2.92881 15.2501 4.99988 15.2501C6.53258 15.2501 7.85052 16.1697 8.43213 17.4871L17.3461 1.63257Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconScissors as IconComponentType).keywords = [
  "scissors",
  "pair of scissors",
  "snips",
  "shears",
...
export default IconScissors as IconComponentType;
