  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M22 14.0005V12.0005C22 8.22925 22 6.34363 20.8284 5.17206C19.6569 4.00049 17.7712 4.00049 14 4.00049H10C6.22876 4.00049 4.34315 4.00049 3.17157 5.17206C2 6.34363 2 8.22925 2 12.0005V14.0005C2 17.7717 2 19.6573 3.17157 20.8289C4.34315 22.0005 6.22876 22.0005 10 22.0005H14"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M18.75 16.5005C17.5074 16.5005 16.5 17.5078 16.5 18.7505C16.5 19.9931 17.5074 21.0005 18.75 21.0005C19.9926 21.0005 21 19.9931 21 18.7505C21 17.5078 19.9926 16.5005 18.75 16.5005ZM15 18.7505C15 16.6794 16.6789 15.0005 18.75 15.0005C20.8211 15.0005 22.5 16.6794 22.5 18.7505C22.5 19.5148 22.2713 20.2257 21.8787 20.8185L23.2803 22.2202C23.5732 22.5131 23.5732 22.9879 23.2803 23.2808C22.9874 23.5737 22.5126 23.5737 22.2197 23.2808L20.818 21.8792C20.2252 22.2718 19.5143 22.5005 18.75 22.5005C16.6789 22.5005 15 20.8216 15 18.7505Z"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M18 15.7505C16.7574 15.7505 15.75 16.7578 15.75 18.0005C15.75 19.2431 16.7574 20.2505 18 20.2505C19.2426 20.2505 20.25 19.2431 20.25 18.0005C20.25 16.7578 19.2426 15.7505 18 15.7505ZM14.25 18.0005C14.25 15.9294 15.9289 14.2505 18 14.2505C20.0711 14.2505 21.75 15.9294 21.75 18.0005C21.75 18.7648 21.5213 19.4757 21.1287 20.0685L22.5303 21.4702C22.8232 21.7631 22.8232 22.2379 22.5303 22.5308C22.2374 22.8237 21.7626 22.8237 21.4697 22.5308L20.068 21.1292C19.4752 21.5218 18.7643 21.7505 18 21.7505C15.9289 21.7505 14.25 20.0716 14.25 18.0005Z"
            fill="currentColor"
          />
          <path
