...
const IconTransferHorizontal: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconTransferHorizontal as IconComponentType).keywords = [
  "transfer",
  "horizontal",
  "transference",
  "transport",
...
export default IconTransferHorizontal as IconComponentType;
