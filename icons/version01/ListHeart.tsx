...
const IconListHeart: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            d="M14 15.0363C14 16.2711 15.4849 17.5791 16.5203 18.341C16.9546 18.6606 17.1717 18.8204 17.5 18.8204C17.8283 18.8204 18.0454 18.6606 18.4797 18.341C19.5151 17.5791 21 16.2712 21 15.0363C21 13.0284 19.0749 12.2788 17.5 13.8299C15.9251 12.2788 14 13.0284 14 15.0363Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconListHeart as IconComponent).keywords = [
  "list",
  "heart",
  "tilt",
  "inclination",
...
export default IconListHeart as IconComponent;
