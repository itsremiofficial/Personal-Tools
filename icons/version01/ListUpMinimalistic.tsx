...
const IconListUpMinimalistic: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconListUpMinimalistic as IconComponentType).keywords = [
  "list",
  "up",
  "minimalistic",
  "tilt",
...
export default IconListUpMinimalistic as IconComponentType;
