...
(IconRoundArrowDown as IconComponentType).keywords = [
  "round",
  "arrow",
  "down",
  "orbicular",
...
export default IconRoundArrowDown as IconComponentType;