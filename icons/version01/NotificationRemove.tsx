...
const IconNotificationRemove: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconNotificationRemove as IconComponentType).keywords = [
  "notification",
  "remove",
  "apprisal",
  "notice",
...
export default IconNotificationRemove as IconComponentType;
