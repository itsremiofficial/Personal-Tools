...
const IconBatteryLowMinimalistic: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconBatteryLowMinimalistic as IconComponentType).keywords = [
  "battery",
  "low",
  "minimalistic",
  "bombardment",
...
export default IconBatteryLowMinimalistic as IconComponentType;
