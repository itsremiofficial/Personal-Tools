...
(IconCardholder as IconComponentType).keywords = [
  "cardholder",
  "registrant",
  "proprietor",
  "patentee",
...
export default IconCardholder as IconComponentType;