...
const IconRewind15SecondsForward: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconRewind15SecondsForward as IconComponentType).keywords = [
  "rewind",
  "15",
  "seconds",
  "forward",
...
export default IconRewind15SecondsForward as IconComponentType;
