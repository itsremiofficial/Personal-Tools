...
const IconUserPlusRounded: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M20.4141 18.5004H18.9999M18.9999 18.5004H17.5857M18.9999 18.5004L18.9999 17.0862M18.9999 18.5004L18.9999 19.9146"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
...
(IconUserPlusRounded as IconComponentType).keywords = [
  "user",
  "plus",
  "rounded",
  "exploiter",
...
export default IconUserPlusRounded as IconComponentType;
