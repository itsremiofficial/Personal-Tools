...
(IconCrownMinimalistic as IconComponentType).keywords = [
  "crown",
  "minimalistic",
  "diadem",
  "coronate",
...
export default IconCrownMinimalistic as IconComponentType;
