...
const IconUserMinusRounded: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M20.4141 18.5005H18.9999H17.5857"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M16.8359 18.5005C16.8359 18.0863 17.1717 17.7505 17.5859 17.7505H20.4144C20.8286 17.7505 21.1644 18.0863 21.1644 18.5005C21.1644 18.9147 20.8286 19.2505 20.4144 19.2505H17.5859C17.1717 19.2505 16.8359 18.9147 16.8359 18.5005Z"
            fill="currentColor"
          />
          <path
            d="M18.8768 16.2505H17.5859C16.3433 16.2505 15.3359 17.2578 15.3359 18.5005C15.3359 19.1936 15.6494 19.8136 16.1422 20.2263C14.9824 20.7136 13.55 21.0015 12 21.0015C8.13401 21.0015 5 19.2106 5 17.0015C5 14.7923 8.13401 13.0015 12 13.0015C15.4168 13.0015 18.2618 14.4003 18.8768 16.2505Z"
            fill="currentColor"
          />
        </svg>
      )}
...
(IconUserMinusRounded as IconComponentType).keywords = [
  "user",
  "minus",
  "rounded",
  "exploiter",
...
export default IconUserMinusRounded as IconComponentType;
