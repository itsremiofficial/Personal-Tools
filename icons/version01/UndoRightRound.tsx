...
(IconUndoRightRound as IconComponentType).keywords = [
  "undo",
  "right",
  "round",
  "unmake",
...
export default IconUndoRightRound as IconComponentType;
