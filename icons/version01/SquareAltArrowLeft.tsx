...
const IconSquareAltArrowLeft: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconSquareAltArrowLeft as IconComponentType).keywords = [
  "square",
  "alt",
  "arrow",
  "left",
...
export default IconSquareAltArrowLeft as IconComponentType;
