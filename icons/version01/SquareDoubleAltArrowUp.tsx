...
const IconSquareDoubleAltArrowUp: FC<IconProps> = ({ className, fill = false, duotone = true, width = '1.5' }) => {
  return (
    <>
      {!fill ? (
...
(IconSquareDoubleAltArrowUp as IconComponentType).keywords = [
  "square",
  "double",
  "alt",
  "arrow",
...
export default IconSquareDoubleAltArrowUp as IconComponentType;