  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M18.5002 12.0001C18.5002 13.3808 17.381 14.5001 16.0002 14.5001C14.6195 14.5001 13.5002 13.3808 13.5002 12.0001C13.5002 10.6194 14.6195 9.50012 16.0002 9.50012C17.381 9.50012 18.5002 10.6194 18.5002 12.0001Z"
            stroke="currentColor"
            strokeWidth={width}
          />
          <path
        ...
        >
          <path
            opacity={duotone ? "0.5" : "1"}
            d="M12 22.0001C17.5228 22.0001 22 17.523 22 12.0001C22 6.47727 17.5228 2.00012 12 2.00012C6.47715 2.00012 2 6.47727 2 12.0001C2 17.523 6.47715 22.0001 12 22.0001Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
