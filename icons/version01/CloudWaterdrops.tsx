      ...
      {!fill ? (
        ...
        >
          <path
            ...
            d="M14.381 8.02721C14.9767 7.81911 15.6178 7.70588 16.2857 7.70588C16.9404 7.70588 17.5693 7.81468 18.1551 8.01498M7.11616 10.6089C6.8475 10.5567 6.56983 10.5294 6.28571 10.5294C3.91878 10.5294 2 12.4256 2 14.7647C2 16.6611 3.26124 18.2664 5 18.8061M7.11616 10.6089C6.88706 9.9978 6.7619 9.33687 6.7619 8.64706C6.7619 5.52827 9.32028 3 12.4762 3C15.4159 3 17.8371 5.19371 18.1551 8.01498M7.11616 10.6089C7.68059 10.7184 8.20528 10.9374 8.66667 11.2426M18.1551 8.01498C20.393 8.78024 22 10.8811 22 13.3529C22 15.6958 20.5562 17.7055 18.5 18.5604"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
          <path
            d="M11 20.3333C11 21.2538 10.3284 22 9.5 22C8.67157 22 8 21.2538 8 20.3333C8 19.8285 8.45122 19.1755 8.85871 18.6888C9.19832 18.2831 9.80168 18.2831 10.1413 18.6888C10.5488 19.1755 11 19.8285 11 20.3333Z"
            stroke="currentColor"
            strokeWidth={width}
          />
          <path
            d="M16 20.3333C16 21.2538 15.3284 22 14.5 22C13.6716 22 13 21.2538 13 20.3333C13 19.8285 13.4512 19.1755 13.8587 18.6888C14.1983 18.2831 14.8017 18.2831 15.1413 18.6888C15.5488 19.1755 16 19.8285 16 20.3333Z"
            stroke="currentColor"
            strokeWidth={width}
          />
          <path
            d="M13.5 15.3333C13.5 16.2538 12.8284 17 12 17C11.1716 17 10.5 16.2538 10.5 15.3333C10.5 14.8285 10.9512 14.1755 11.3587 13.6888C11.6983 13.2831 12.3017 13.2831 12.6413 13.6888C13.0488 14.1755 13.5 14.8285 13.5 15.3333Z"
            stroke="currentColor"
            strokeWidth={width}
          />
        </svg>
...
(IconCloudWaterdrops as IconComponentType).keywords = [
  "cloud",
  "waterdrops",
  "fog",
  "mist",
...
export default IconCloudWaterdrops as IconComponentType;
