...
const IconAirbudsCase: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconAirbudsCase as IconComponentType).keywords = [
  "airbuds",
  "case",
  "event",
  "cause",
...
export default IconAirbudsCase as IconComponentType;
