    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M12 9.00049V13.0005L14.5 15.5005"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
        ...
        >
          <path
            opacity={duotone ? "0.5" : "1"}
            d="M12 22.0004C16.8362 22.0004 20.7567 18.1167 20.7567 13.3258C20.7567 8.5349 16.8362 4.65112 12 4.65112C7.16384 4.65112 3.24335 8.5349 3.24335 13.3258C3.24335 18.1167 7.16384 22.0004 12 22.0004Z"
            fill="currentColor"
          />
          <path
            d="M11.9997 8.74756C12.4028 8.74756 12.7295 9.07121 12.7295 9.47045V13.0264L14.9481 15.2243C15.2331 15.5066 15.2331 15.9643 14.9481 16.2466C14.6632 16.5289 14.2011 16.5289 13.9162 16.2466L11.4838 13.837C11.3469 13.7014 11.27 13.5176 11.27 13.3258V9.47045C11.27 9.07121 11.5967 8.74756 11.9997 8.74756Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M15.7595 2.34034C15.9731 2.00179 16.4233 1.89887 16.7651 2.11047L20.6569 4.52009C20.9987 4.73169 21.1026 5.17768 20.889 5.51623C20.6754 5.85478 20.2252 5.9577 19.8834 5.74611L15.9916 3.33648C15.6498 3.12488 15.5459 2.6789 15.7595 2.34034Z"
            fill="currentColor"
          />
        </svg>
      )}
