...
const IconRewind10SecondsForward: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconRewind10SecondsForward as IconComponentType).keywords = [
  "rewind",
  "10",
  "seconds",
  "forward",
...
export default IconRewind10SecondsForward as IconComponentType;
