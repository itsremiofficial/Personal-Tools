...
const IconArrowToTopLeft: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.5" : "1"}>
            ...
            />
            <path
              d="M12.1977 3.77639C12.0432 3.73435 11.878 3.74254 11.7278 3.80095C11.8122 3.76805 11.904 3.75 12 3.75C12.0684 3.75 12.1347 3.75919 12.1977 3.77639Z"
              fill="currentColor"
            />
          </g>
        </svg>
...
(IconArrowToTopLeft as IconComponent).keywords = [
  "arrow",
  "to",
  "top",
  "left",
...
export default IconArrowToTopLeft as IconComponent;
