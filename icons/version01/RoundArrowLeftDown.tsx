...
const IconRoundArrowLeftDown: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconRoundArrowLeftDown as IconComponentType).keywords = [
  "round",
  "arrow",
  "left",
  "down",
...
export default IconRoundArrowLeftDown as IconComponentType;
