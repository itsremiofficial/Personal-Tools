...
const IconLocationAdd: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconLocationAdd as IconComponentType).keywords = [
  "location",
  "add",
  "position",
  "placement",
...
export default IconLocationAdd as IconComponentType;
