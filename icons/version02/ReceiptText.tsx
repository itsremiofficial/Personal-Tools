...
(IconReceiptText as IconComponentType).keywords = [
  "receipt",
  "text",
  "receiving",
  "reception",
...
export default IconReceiptText as IconComponentType;