      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M16.4199 8H11.4199C9.76992 8 8.41992 9.35 8.41992 11V12V13C8.41992 14.65 9.76992 16 11.4199 16H16.4199"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M16.4199 12.75C16.8299 12.75 17.1699 12.41 17.1699 12C17.1699 11.59 16.8299 11.25 16.4199 11.25H9.16992V11C9.16992 9.76 10.1799 8.75 11.4199 8.75H16.4199C16.8299 8.75 17.1699 8.41 17.1699 8C17.1699 7.59 16.8299 7.25 16.4199 7.25H11.4199C9.34992 7.25 7.66992 8.93 7.66992 11V13C7.66992 15.07 9.34992 16.75 11.4199 16.75H16.4199C16.8299 16.75 17.1699 16.41 17.1699 16C17.1699 15.59 16.8299 15.25 16.4199 15.25H11.4199C10.1799 15.25 9.16992 14.24 9.16992 13V12.75H16.4199Z"
            fill="currentColor"
          />
        </svg>
      ) : (
