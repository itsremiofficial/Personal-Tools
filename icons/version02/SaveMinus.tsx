    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M11.6699 12.75H7.66992C7.25992 12.75 6.91992 12.41 6.91992 12C6.91992 11.59 7.25992 11.25 7.66992 11.25H11.6699C12.0799 11.25 12.4199 11.59 12.4199 12C12.4199 12.41 12.0799 12.75 11.6699 12.75Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconSaveMinus as IconComponentType).keywords = [
  "save",
  "minus",
  "save up",
  "lay aside",
...
export default IconSaveMinus as IconComponentType;
