      ...
      {!fill ? (
        ...
        >
          ...
          <path
            ...
            d="M22.6699 12.9V4.1C22.6699 2.6 22.0299 2 20.4399 2H16.3999C14.8099 2 14.1699 2.6 14.1699 4.1V12.9C14.1699 14.4 14.8099 15 16.3999 15H20.4399C22.0299 15 22.6699 14.4 22.6699 12.9Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
