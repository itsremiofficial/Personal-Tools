    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M12.6699 14.75C12.2599 14.75 11.9199 14.41 11.9199 14V10C11.9199 9.59 12.2599 9.25 12.6699 9.25C13.0799 9.25 13.4199 9.59 13.4199 10V14C13.4199 14.42 13.0799 14.75 12.6699 14.75Z"
            fill="currentColor"
          />
          <path
            d="M15.6699 14.75C15.2599 14.75 14.9199 14.41 14.9199 14V12C14.9199 11.59 15.2599 11.25 15.6699 11.25C16.0799 11.25 16.4199 11.59 16.4199 12V14C16.4199 14.42 16.0899 14.75 15.6699 14.75Z"
            fill="currentColor"
          />
          <path
            d="M9.66992 14.75C9.25992 14.75 8.91992 14.41 8.91992 14V13C8.91992 12.59 9.25992 12.25 9.66992 12.25C10.0799 12.25 10.4199 12.59 10.4199 13V14C10.4199 14.42 10.0799 14.75 9.66992 14.75Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconWatchStatus as IconComponentType).keywords = [
  "watch",
  "status",
  "picket",
  "ticker",
...
export default IconWatchStatus as IconComponentType;
