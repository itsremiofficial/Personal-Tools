  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M4.8403 15.3L9.3703 19.83C11.2303 21.69 14.2503 21.69 16.1203 19.83L20.5103 15.44C22.3703 13.58 22.3703 10.56 20.5103 8.69005L15.9703 4.17005C15.0203 3.22005 13.7103 2.71005 12.3703 2.78005L7.3703 3.02005C5.3703 3.11005 3.7803 4.70005 3.6803 6.69005L3.4403 11.69C3.3803 13.04 3.8903 14.35 4.8403 15.3Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          ...
          <path
            ...
            d="M10.1699 12C11.5506 12 12.6699 10.8807 12.6699 9.5C12.6699 8.11929 11.5506 7 10.1699 7C8.78921 7 7.66992 8.11929 7.66992 9.5C7.66992 10.8807 8.78921 12 10.1699 12Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
...
(IconTag as IconComponent).keywords = [
  "tag",
  "label",
  "mark",
  "trail",
...
export default IconTag as IconComponent;
