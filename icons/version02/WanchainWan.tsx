      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M17.1699 8.85004L12.6699 6.15002L8.16992 8.85004"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
            ...
            />
            <path
              d="M8.16992 9V15.15L12.6699 12.45L17.1699 15.15V9"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
          ...
          <path
            ...
            d="M14.9199 16.2L12.6699 17.7L10.4199 16.2"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M17.1697 9.16V12.99C17.1697 13.77 16.3197 14.25 15.6597 13.85L13.1897 12.37C12.8697 12.18 12.4797 12.18 12.1597 12.37L9.6897 13.85C9.0197 14.25 8.17969 13.77 8.17969 12.99V9.16C8.17969 8.82 8.35969 8.5 8.63969 8.32L12.1397 6.1C12.4697 5.89 12.8797 5.89 13.2097 6.1L16.7097 8.32C16.9897 8.5 17.1697 8.82 17.1697 9.16Z"
            fill="currentColor"
          />
          <path
            d="M12.6699 18.06C12.5199 18.06 12.3799 18.02 12.2499 17.93L9.99987 16.43C9.65987 16.2 9.55986 15.73 9.78986 15.39C10.0199 15.04 10.4899 14.95 10.8299 15.18L12.6599 16.4L14.4899 15.18C14.8299 14.95 15.2999 15.04 15.5299 15.39C15.7599 15.73 15.6699 16.2 15.3199 16.43L13.0699 17.93C12.9599 18.02 12.8199 18.06 12.6699 18.06Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconWanchainWan as IconComponentType).keywords = [
  "wanchain",
  "wan",
  "pallid",
  "weak",
...
export default IconWanchainWan as IconComponentType;
