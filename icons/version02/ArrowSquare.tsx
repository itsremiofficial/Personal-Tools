...
const IconArrowSquare: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M12.8105 15.0701V13.11C12.8105 10.59 14.8506 8.54004 17.3806 8.54004H19.3405"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
            ...
            />
            <path
              d="M6.29004 8.5498H8.25006C10.7701 8.5498 12.8201 10.5898 12.8201 13.1198V13.7698V17.2498"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M7.80975 6.75L6.00977 8.55L7.80975 10.35"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M17.5293 6.75L19.3293 8.55L17.5293 10.35"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
