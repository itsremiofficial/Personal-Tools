    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M6.66992 14.89C6.25992 14.89 5.91992 14.55 5.91992 14.14V9.84998C5.91992 9.43998 6.25992 9.09998 6.66992 9.09998C7.07992 9.09998 7.41992 9.43998 7.41992 9.84998V14.14C7.41992 14.56 7.07992 14.89 6.66992 14.89Z"
            fill="currentColor"
          />
          <path
            d="M9.66992 16.32C9.25992 16.32 8.91992 15.98 8.91992 15.57V8.42999C8.91992 8.01999 9.25992 7.67999 9.66992 7.67999C10.0799 7.67999 10.4199 8.01999 10.4199 8.42999V15.57C10.4199 15.99 10.0799 16.32 9.66992 16.32Z"
            fill="currentColor"
          />
          <path
            d="M12.6699 17.75C12.2599 17.75 11.9199 17.41 11.9199 17V7C11.9199 6.59 12.2599 6.25 12.6699 6.25C13.0799 6.25 13.4199 6.59 13.4199 7V17C13.4199 17.41 13.0799 17.75 12.6699 17.75Z"
            fill="currentColor"
          />
          <path
            d="M15.6699 16.32C15.2599 16.32 14.9199 15.98 14.9199 15.57V8.42999C14.9199 8.01999 15.2599 7.67999 15.6699 7.67999C16.0799 7.67999 16.4199 8.01999 16.4199 8.42999V15.57C16.4199 15.99 16.0799 16.32 15.6699 16.32Z"
            fill="currentColor"
          />
          <path
            d="M18.6699 14.89C18.2599 14.89 17.9199 14.55 17.9199 14.14V9.84998C17.9199 9.43998 18.2599 9.09998 18.6699 9.09998C19.0799 9.09998 19.4199 9.43998 19.4199 9.84998V14.14C19.4199 14.56 19.0799 14.89 18.6699 14.89Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconVoiceSquare as IconComponentType).keywords = [
  "voice",
  "square",
  "vocalization",
  "interpreter",
...
export default IconVoiceSquare as IconComponentType;
