...
const IconChartFail: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M17.9004 20.7705L21.4404 17.2305"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
            ...
            />
            <path
              d="M21.4404 20.7705L17.9004 17.2305"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
...
(IconChartFail as IconComponentType).keywords = [
  "chart",
  "fail",
  "map",
  "cartography",
...
export default IconChartFail as IconComponentType;
