...
const IconTextalignJustifyright: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M21.6719 5.25H12.6719C12.2619 5.25 11.9219 4.91 11.9219 4.5C11.9219 4.09 12.2619 3.75 12.6719 3.75H21.6719C22.0819 3.75 22.4219 4.09 22.4219 4.5C22.4219 4.91 22.0819 5.25 21.6719 5.25Z"
            fill="currentColor"
          />
          <path
            d="M21.6719 10.25H12.6719C12.2619 10.25 11.9219 9.91 11.9219 9.5C11.9219 9.09 12.2619 8.75 12.6719 8.75H21.6719C22.0819 8.75 22.4219 9.09 22.4219 9.5C22.4219 9.91 22.0819 10.25 21.6719 10.25Z"
            fill="currentColor"
          />
          <path
            d="M21.6719 15.25H3.67188C3.26188 15.25 2.92188 14.91 2.92188 14.5C2.92188 14.09 3.26188 13.75 3.67188 13.75H21.6719C22.0819 13.75 22.4219 14.09 22.4219 14.5C22.4219 14.91 22.0819 15.25 21.6719 15.25Z"
...
(IconTextalignJustifyright as IconComponentType).keywords = [
  "textalign",
  "justifyright",
];

export default IconTextalignJustifyright as IconComponentType;
