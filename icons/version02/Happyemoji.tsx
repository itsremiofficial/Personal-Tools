      ...
      {!fill ? (
        ...
        >
          ...
          <path
            ...
            d="M7.87988 16C8.92988 17.51 10.6899 18.5 12.6699 18.5C14.6499 18.5 16.3999 17.51 17.4599 16"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M12.6698 19.25C10.5198 19.25 8.4998 18.2 7.2698 16.43C7.0298 16.09 7.1198 15.62 7.4598 15.39C7.7998 15.15 8.2698 15.24 8.4998 15.58C9.4498 16.94 11.0098 17.76 12.6698 17.76C14.3298 17.76 15.8898 16.95 16.8398 15.58C17.0798 15.24 17.5398 15.16 17.8798 15.39C18.2198 15.63 18.2998 16.09 18.0698 16.43C16.8398 18.2 14.8198 19.25 12.6698 19.25Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconHappyemoji as IconComponentType).keywords = ["happyemoji"];
