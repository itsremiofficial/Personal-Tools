    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M22.6599 10.8399C22.6399 10.3499 22.5599 9.88994 22.4099 9.43994H2.66992V16.6499C2.66992 19.5999 5.06992 21.9999 8.01992 21.9999H17.3199C20.2699 21.9999 22.6699 19.5999 22.6699 16.6499V11.0699C22.6699 10.9999 22.6699 10.9099 22.6599 10.8399ZM15.0999 16.2999H10.0999C9.68992 16.2999 9.34992 15.9599 9.34992 15.5499C9.34992 15.1399 9.68992 14.7999 10.0999 14.7999H15.0999C15.5099 14.7999 15.8499 15.1399 15.8499 15.5499C15.8499 15.9599 15.5099 16.2999 15.0999 16.2999Z"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          ...
          />
          <path
            d="M22.6533 11.7459C22.6514 11.1949 22.2042 10.7493 21.6533 10.7493L3.66989 10.75C3.11762 10.75 2.66992 11.1977 2.66992 11.75V16.65C2.66992 19.6 5.06992 22 8.01992 22H17.3199C20.2699 22 22.6699 19.6 22.6699 16.65L22.6533 11.7459ZM15.0999 16.75H10.0999C9.67992 16.75 9.34992 16.42 9.34992 16C9.34992 15.59 9.67992 15.25 10.0999 15.25H15.0999C15.5099 15.25 15.8499 15.59 15.8499 16C15.8499 16.42 15.5099 16.75 15.0999 16.75Z"
            fill="currentColor"
          />
        </svg>
      )}
