      ...
      {!fill ? (
        ...
        >
          <path
            ...
            d="M12.9199 12.95V13.88C12.9199 14.23 12.7399 14.56 12.4299 14.74L11.6699 15.2"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M21.71 13.7301C21.9587 13.5919 22.2814 13.7922 22.2555 14.0755L21.9 17.9601C21.69 19.9601 20.87 22.0001 16.47 22.0001H8.85002C4.45002 22.0001 3.63002 19.9601 3.43002 17.9701L3.08415 14.2668C3.0573 13.9793 3.36481 13.785 3.62002 13.9201C4.40002 14.3501 5.21002 14.7301 6.04002 15.0301C6.35002 15.1401 6.57002 15.4001 6.66002 15.7201C7.41002 18.3201 9.83002 20.2501 12.67 20.2501C15.56 20.2501 18 18.2801 18.71 15.5801C18.79 15.2601 19.01 15.0001 19.32 14.8801C20.16 14.5501 20.96 14.1601 21.71 13.7301Z"
            fill="currentColor"
          />
        </svg>
      )}
...
(IconBrifecaseTimer as IconComponentType).keywords = [
  "brifecase",
  "timer",
  "clocking",
  "timekeeping",
...
export default IconBrifecaseTimer as IconComponentType;
