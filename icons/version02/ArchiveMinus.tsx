...
const IconArchiveMinus: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M15.1699 11.3999H10.1699C9.75992 11.3999 9.41992 11.0599 9.41992 10.6499C9.41992 10.2399 9.75992 9.8999 10.1699 9.8999H15.1699C15.5799 9.8999 15.9199 10.2399 15.9199 10.6499C15.9199 11.0599 15.5799 11.3999 15.1699 11.3999Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconArchiveMinus as IconComponentType).keywords = [
  "archive",
  "minus",
  "file away",
  "archival",
...
export default IconArchiveMinus as IconComponentType;
