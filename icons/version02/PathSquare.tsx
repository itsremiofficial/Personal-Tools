      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M17.4202 9.11998L15.5702 7.26998C14.8702 6.56998 13.9102 6.60998 13.4402 7.34998L12.4102 8.97998L15.7002 12.27L17.3302 11.24C18.0402 10.8 18.0802 9.76998 17.4202 9.11998Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
            ...
            />
            <path
              d="M12.4094 8.98017L10.0194 8.84017C8.6794 8.76017 8.2194 9.17017 8.0694 10.4402L7.4694 15.5102C7.3394 16.5802 8.1094 17.3402 9.1794 17.2202L14.2494 16.6202C15.5194 16.4702 15.9794 16.0102 15.8494 14.6702L15.7094 12.2802"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M8.16016 16.5199L10.0102 14.6699"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M17.3302 11.25L15.7102 12.27L12.4102 8.97998L13.4402 7.34998C13.9102 6.60998 14.8702 6.56998 15.5702 7.26998L17.4202 9.11998C18.0802 9.76998 18.0402 10.8 17.3302 11.25Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.6" : "1"}
            d="M14.2495 16.6199L9.17951 17.2199C8.95951 17.2499 8.75951 17.2399 8.56951 17.1799C8.01951 17.0599 7.62951 16.6699 7.50951 16.1199C7.44951 15.9299 7.43951 15.7299 7.46951 15.5099L8.05951 10.4399C8.21951 9.16993 8.67951 8.75993 10.0195 8.83993L12.4095 8.97993L15.7095 12.2699L15.8495 14.6699C15.9795 16.0099 15.5195 16.4699 14.2495 16.6199Z"
            fill="currentColor"
          />
          <path
            d="M10.5498 15.2001L8.56977 17.1801C8.01977 17.0601 7.62977 16.6701 7.50977 16.1201L9.47977 14.1401C9.77977 13.8501 10.2498 13.8501 10.5498 14.1401C10.8398 14.4301 10.8398 14.9101 10.5498 15.2001Z"
            fill="currentColor"
          />
        </svg>
      ) : (
