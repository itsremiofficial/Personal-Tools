...
const IconArrowSquareUp: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          ...
          <path
            ...
            d="M9.14014 13.4599L12.6701 9.93994L16.2001 13.4599"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M16.2001 14.21C16.0101 14.21 15.8201 14.14 15.6701 13.99L12.6701 10.99L9.67008 13.99C9.38008 14.28 8.90008 14.28 8.61008 13.99C8.32008 13.7 8.32008 13.22 8.61008 12.93L12.1401 9.4C12.4301 9.11 12.9101 9.11 13.2001 9.4L16.7301 12.93C17.0201 13.22 17.0201 13.7 16.7301 13.99C16.5801 14.14 16.3901 14.21 16.2001 14.21Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconArrowSquareUp as IconComponent).keywords = [
  "arrow",
  "square",
  "up",
  "pointer",
...
export default IconArrowSquareUp as IconComponent;
