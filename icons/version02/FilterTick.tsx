...
const IconFilterTick: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M15.7002 14.75L16.8702 15.92L19.4001 13.58"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          <path
            ...
            d="M21.3595 4.01999V6.23999C21.3595 7.04999 20.8495 8.06001 20.3495 8.57001L18.5895 10.12C18.2595 10.04 17.9095 10 17.5495 10C14.9295 10 12.7995 12.13 12.7995 14.75C12.7995 15.64 13.0495 16.48 13.4895 17.2C13.8595 17.82 14.3695 18.35 14.9895 18.73V19.07C14.9895 19.68 14.5895 20.49 14.0795 20.79L12.6695 21.7C11.3595 22.51 9.53949 21.6 9.53949 19.98V14.63C9.53949 13.92 9.12949 13.01 8.72949 12.51L4.88947 8.47C4.38947 7.96 3.97949 7.05001 3.97949 6.45001V4.12C3.97949 2.91 4.88951 2 5.99951 2H19.3395C20.4495 2 21.3595 2.90999 21.3595 4.01999Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
...
(IconFilterTick as IconComponent).keywords = [
  "filter",
  "tick",
  "filtrate",
  "filter out",
...
export default IconFilterTick as IconComponent;
