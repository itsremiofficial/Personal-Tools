...
const IconTextalignJustifycenter: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M21.6719 10.25H3.67188C3.26188 10.25 2.92188 9.91 2.92188 9.5C2.92188 9.09 3.26188 8.75 3.67188 8.75H21.6719C22.0819 8.75 22.4219 9.09 22.4219 9.5C22.4219 9.91 22.0819 10.25 21.6719 10.25Z"
            fill="currentColor"
          />
          <path
