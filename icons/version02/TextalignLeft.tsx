...
const IconTextalignLeft: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M13.1419 10.25H3.67188C3.26188 10.25 2.92188 9.91 2.92188 9.5C2.92188 9.09 3.26188 8.75 3.67188 8.75H13.1419C13.5519 8.75 13.8919 9.09 13.8919 9.5C13.8919 9.91 13.5619 10.25 13.1419 10.25Z"
            fill="currentColor"
          />
          <path
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M13.1419 20.25H3.67188C3.26188 20.25 2.92188 19.91 2.92188 19.5C2.92188 19.09 3.26188 18.75 3.67188 18.75H13.1419C13.5519 18.75 13.8919 19.09 13.8919 19.5C13.8919 19.91 13.5619 20.25 13.1419 20.25Z"
            fill="currentColor"
          />
        </svg>
      ) : (
