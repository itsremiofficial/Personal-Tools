...
const IconCopy: FC<IconCopyProps> = ({ className, duotone = true }) => {
  return (
    <svg
      className={className}
      fill="currentColor"
    ...
    >
      ...
      <path d="M11.9806 7.15024C11.6706 6.84024 11.1406 7.05024 11.1406 7.48024V10.1002C11.1406 11.2002 12.0706 12.1002 13.2106 12.1002C13.9206 12.1102 14.9106 12.1102 15.7606 12.1102C16.1906 12.1102 16.4106 11.6102 16.1106 11.3102C15.0206 10.2202 13.0806 8.27024 11.9806 7.15024Z" />
    </svg>
  );
};
