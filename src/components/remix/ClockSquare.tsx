...
const IconClockSquare: FC<IconProps> = ({ className, fill = false, duotone = true, width = '1.5' }) => {
  return (
    <>
      {!fill ? (
...
(IconClockSquare as IconComponentType).keywords = [
  "clock",
  "square",
  "time",
  "stopwatch",
...
export default IconClockSquare as IconComponentType;