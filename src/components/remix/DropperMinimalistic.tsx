...
(IconDropperMinimalistic as IconComponentType).keywords = [
  "dropper",
  "minimalistic",
  "eye dropper",
  "strainer",
...
export default IconDropperMinimalistic as IconComponentType;