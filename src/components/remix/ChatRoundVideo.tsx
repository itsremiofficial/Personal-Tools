...
(IconChatRoundVideo as IconComponentType).keywords = [
  "chat",
  "round",
  "video",
  "confabulate",
...
export default IconChatRoundVideo as IconComponentType;