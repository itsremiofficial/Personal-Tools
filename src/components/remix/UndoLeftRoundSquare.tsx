...
(IconUndoLeftRoundSquare as IconComponentType).keywords = [
  "undo",
  "left",
  "round",
  "square",
...
export default IconUndoLeftRoundSquare as IconComponentType;