...
(IconGalleryMinimalistic as IconComponentType).keywords = [
  "gallery",
  "minimalistic",
  "art gallery",
  "heading",
...
export default IconGalleryMinimalistic as IconComponentType;