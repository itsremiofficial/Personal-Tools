...
(IconEmptyWalletRemove as IconComponentType).keywords = [
  "empty",
  "wallet",
  "remove",
  "lifeless",
...
export default IconEmptyWalletRemove as IconComponentType;