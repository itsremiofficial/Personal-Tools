...
const IconMagniferZoomOut: FC<IconProps> = ({ className, fill = false, duotone = true, width = '1.5' }) => {
  return (
    <>
      {!fill ? (
...
(IconMagniferZoomOut as IconComponentType).keywords = [
  "magnifer",
  "zoom",
  "out",
  "whizz",
...
export default IconMagniferZoomOut as IconComponentType;