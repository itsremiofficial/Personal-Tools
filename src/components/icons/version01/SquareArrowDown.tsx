...
(IconSquareArrowDown as IconComponentType).keywords = [
  "square",
  "arrow",
  "down",
  "quadrate",
...
export default IconSquareArrowDown as IconComponentType;