...
(IconTextItalicSquare as IconComponent).keywords = [
  "text",
  "italic",
  "square",
  "schoolbook",
...
export default IconTextItalicSquare as IconComponent;