...
const IconSquareTopDown: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconSquareTopDown as IconComponent).keywords = [
  "square",
  "top",
  "down",
  "quadrate",
...
export default IconSquareTopDown as IconComponent;
