...
const IconSquareTransferHorizontal: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconSquareTransferHorizontal as IconComponent).keywords = [
  "square",
  "transfer",
  "horizontal",
  "quadrate",
...
export default IconSquareTransferHorizontal as IconComponent;
