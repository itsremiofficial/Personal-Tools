...
(IconRewind5SecondsForward as IconComponent).keywords = [
  "rewind",
  "5",
  "seconds",
  "forward",
...
export default IconRewind5SecondsForward as IconComponent;