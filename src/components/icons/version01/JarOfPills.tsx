...
const IconJarOfPills: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M5.50122 7.79927L7.90434 5.87677C8.44688 5.44274 8.71814 5.22573 9.03955 5.11299C9.36095 5.00024 9.70834 5.00024 10.4031 5.00024H13.6427C14.3438 5.00024 14.6943 5.00024 15.0182 5.11491C15.3421 5.22957 15.6146 5.45014 16.1595 5.89126L18.5168 7.79955C19.455 8.55901 20 9.7015 20 10.9085V17.5652C20 18.4929 19.6775 19.3918 19.0877 20.108L18.7294 20.5431C17.9696 21.4657 16.837 22.0002 15.6417 22.0002H8.95693C8.38582 22.0002 8.10026 22.0002 7.82957 21.9631C7.02661 21.8529 6.27608 21.5013 5.67738 20.9551C5.47554 20.7709 5.29272 20.5515 4.92711 20.1128C4.32806 19.3939 4 18.4878 4 17.552V10.9227C4 9.70761 4.55236 8.55836 5.50122 7.79927Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
          <path
            d="M12 12.0002V16.0002M10 14.0002L14 14.0002"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
        ...
        >
          ...
          <path
            opacity={duotone ? "0.5" : "1"}
            d="M4 10.9227V17.552C4 17.7024 4.00847 17.852 4.02518 18.0002H19.9763C19.992 17.8563 20 17.7111 20 17.5652V10.9085C20 10.5998 19.9643 10.2952 19.8955 10.0002H4.10779C4.03683 10.2996 4 10.609 4 10.9227Z"
            fill="currentColor"
          />
          <path
            d="M5.50118 7.79927L8.99996 5.00024H15.0182L16.1595 5.89126L18.5168 7.79955C19.2149 8.36474 19.6954 9.14206 19.8955 10.0002H4.10776C4.31164 9.14014 4.79732 8.36236 5.50118 7.79927Z"
            fill="currentColor"
          />
          <path
            d="M4.02515 18.0002C4.11241 18.7742 4.4243 19.5094 4.92708 20.1128C5.29269 20.5515 5.4755 20.7709 5.67734 20.9551C6.27605 21.5013 7.02658 21.8529 7.82953 21.9631C8.10023 22.0002 8.38578 22.0002 8.95689 22.0002H15.6417C16.8369 22.0002 17.9696 21.4657 18.7294 20.5431L19.0877 20.108C19.5847 19.5045 19.8919 18.7712 19.9762 18.0002H4.02515Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
        ...
        >
          ...
          />
          <path
            d="M4.92711 20.1127C4.5902 19.7084 4.33901 19.2449 4.18368 18.7502H19.8204C19.6677 19.2425 19.4202 19.7042 19.0877 20.1079L18.7294 20.543C17.9696 21.4657 16.837 22.0002 15.6417 22.0002H8.95693C8.38582 22.0002 8.10026 22.0002 7.82957 21.963C7.02661 21.8528 6.27608 21.5013 5.67738 20.955C5.47554 20.7708 5.29272 20.5514 4.92711 20.1127Z"
            fill="currentColor"
          />
        </svg>
      )}
...
(IconJarOfPills as IconComponent).keywords = [
  "jar",
  "of",
  "pills",
  "collide",
...
export default IconJarOfPills as IconComponent;
