...
(IconClipboardText as IconComponent).keywords = [
  "clipboard",
  "text",
  "flipchart",
  "notebook",
...
export default IconClipboardText as IconComponent;