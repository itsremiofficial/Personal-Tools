...
(IconSquareAltArrowLeft as IconComponent).keywords = [
  "square",
  "alt",
  "arrow",
  "left",
...
export default IconSquareAltArrowLeft as IconComponent;