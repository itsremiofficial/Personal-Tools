...
const IconRoundArrowUp: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconRoundArrowUp as IconComponent).keywords = [
  "round",
  "arrow",
  "up",
  "orbicular",
...
export default IconRoundArrowUp as IconComponent;
