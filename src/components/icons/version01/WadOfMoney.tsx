    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M9.75 19.0004V15.0005H9C7.34315 15.0005 6 13.6573 6 12.0005C6 10.3436 7.34315 9.00049 9 9.00049H9.75V5.00146H8.25C5.93257 5.00678 4.69253 5.06378 3.77772 5.67504C3.34096 5.96687 2.96596 6.34188 2.67412 6.77864C2 7.78753 2 9.19199 2 12.0009C2 14.8098 2 16.2143 2.67412 17.2232C2.96596 17.66 3.34096 18.035 3.77772 18.3268C4.69253 18.9381 5.93258 18.9951 8.25 19.0004H9.75Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.5" : "1"}
            d="M9.75 19.0005L14.25 19.0005V5.00049H9.75V19.0005Z"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          ...
          />
          <path
            d="M15.75 5.00103V9.095C17.0439 9.42803 18 10.6026 18 12.0005C18 13.3984 17.0439 14.5729 15.75 14.906V18.9999C18.0674 18.9946 19.3075 18.9376 20.2223 18.3264C20.659 18.0345 21.034 17.6595 21.3259 17.2228C22 16.2139 22 14.8094 22 12.0005C22 9.19156 22 7.7871 21.3259 6.77821C21.034 6.34145 20.659 5.96644 20.2223 5.67461C19.3075 5.06335 18.0674 5.00635 15.75 5.00103Z"
            fill="currentColor"
          />
        </svg>
      )}
