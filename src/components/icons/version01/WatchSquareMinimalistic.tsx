...
const IconWatchSquareMinimalistic: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M12 9.00049V12.0774L14 14.0005"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M12 8.25049C12.4142 8.25049 12.75 8.58627 12.75 9.00049V11.7581L14.5198 13.4599C14.8184 13.747 14.8277 14.2217 14.5406 14.5203C14.2535 14.8189 13.7787 14.8282 13.4802 14.5411L11.4802 12.618C11.3331 12.4766 11.25 12.2814 11.25 12.0774V9.00049C11.25 8.58627 11.5858 8.25049 12 8.25049Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
...
(IconWatchSquareMinimalistic as IconComponent).keywords = [
  "watch",
  "square",
  "minimalistic",
  "picket",
...
export default IconWatchSquareMinimalistic as IconComponent;
