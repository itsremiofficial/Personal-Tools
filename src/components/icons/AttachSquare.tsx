...
(IconAttachSquare as IconComponentType).keywords = [
  "attach",
  "square",
  "seize",
  "confiscate",
...
export default IconAttachSquare as IconComponentType;