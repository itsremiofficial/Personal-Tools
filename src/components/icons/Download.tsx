...
(IconDownload as IconComponentType).keywords = [
  "download",
  "uploaded",
  "uploading",
  "upload",
...
export default IconDownload as IconComponentType;