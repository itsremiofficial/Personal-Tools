...
const IconRoundDoubleAltArrowLeft: FC<IconProps> = ({ className, fill = false, duotone = true, width = '1.5' }) => {
  return (
    <>
      {!fill ? (
...
(IconRoundDoubleAltArrowLeft as IconComponentType).keywords = [
  "round",
  "double",
  "alt",
  "arrow",
...
export default IconRoundDoubleAltArrowLeft as IconComponentType;