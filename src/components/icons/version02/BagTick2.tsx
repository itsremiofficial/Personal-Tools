...
const IconBagTick2: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M11.1104 15L11.7604 15.65C11.9504 15.84 12.2604 15.85 12.4504 15.66L14.2304 14.02"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M12.0998 16.64C11.9098 16.64 11.7198 16.57 11.5698 16.42L10.5798 15.43C10.2898 15.14 10.2898 14.66 10.5798 14.37C10.8698 14.08 11.3498 14.08 11.6398 14.37L12.1198 14.85L13.7198 13.37C14.0198 13.09 14.4998 13.11 14.7798 13.41C15.0598 13.71 15.0398 14.19 14.7398 14.47L12.6098 16.44C12.4598 16.57 12.2798 16.64 12.0998 16.64Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconBagTick2 as IconComponent).keywords = [
  "bag",
  "tick",
  "2",
  "purse",
...
export default IconBagTick2 as IconComponent;
