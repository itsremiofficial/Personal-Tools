...
const IconArrowSwapHorizontal: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M21.1702 14.9902L16.1602 20.0102"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
          ...
          <path
            d="M4.16992 9.00999L9.17992 3.98999"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M18.3599 13.48C18.2799 13.3 18.1399 13.15 17.9499 13.07C17.8599 13.03 17.7599 13.01 17.6599 13.01H7.66992C7.25992 13.01 6.91992 13.35 6.91992 13.76C6.91992 14.17 7.25992 14.51 7.66992 14.51H15.8599L14.1899 16.18C13.8999 16.47 13.8999 16.95 14.1899 17.24C14.3399 17.39 14.5299 17.46 14.7199 17.46C14.9099 17.46 15.0999 17.39 15.2499 17.24L18.1999 14.29C18.2699 14.22 18.3199 14.14 18.3599 14.05C18.4399 13.86 18.4399 13.66 18.3599 13.48Z"
            fill="currentColor"
          />
          <path
            d="M6.97992 10.52C7.05992 10.7 7.19992 10.85 7.38992 10.93C7.47992 10.97 7.56992 10.99 7.66992 10.99H17.6699C18.0799 10.99 18.4199 10.65 18.4199 10.24C18.4199 9.82998 18.0799 9.48998 17.6699 9.48998H9.47992L11.1499 7.81998C11.4399 7.52998 11.4399 7.04998 11.1499 6.75998C10.8599 6.46998 10.3799 6.46998 10.0899 6.75998L7.13992 9.70998C7.06992 9.77998 7.01992 9.85998 6.97992 9.94998C6.89992 10.14 6.89992 10.34 6.97992 10.52Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconArrowSwapHorizontal as IconComponent).keywords = [
  "arrow",
  "swap",
  "horizontal",
  "pointer",
...
export default IconArrowSwapHorizontal as IconComponent;
