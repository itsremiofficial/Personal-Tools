...
const IconReceived: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M5.66992 7.22998V17.5H15.9399"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          <path
            d="M5.67031 18.2C5.47031 18.2 5.27031 18.1 5.17031 18C4.87031 17.7 4.87031 17.2 5.17031 16.9L19.1703 2.90005C19.4703 2.60005 19.9703 2.60005 20.2703 2.90005C20.5703 3.20005 20.5703 3.70005 20.2703 4.00005L6.27031 18C6.07031 18.2 5.87031 18.2 5.67031 18.2Z"
            fill="currentColor"
          />
          <path
            d="M15.9701 18.2H5.67012C5.27012 18.2 4.87012 17.9 4.87012 17.4V7.20002C4.87012 6.80002 5.17012 6.40002 5.67012 6.40002C6.17012 6.40002 6.47012 6.70002 6.47012 7.20002V16.7H15.9701C16.3701 16.7 16.7701 17 16.7701 17.5C16.7701 18 16.3701 18.2 15.9701 18.2Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.4" : "1"}
