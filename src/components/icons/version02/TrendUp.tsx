      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M17.1699 9.5L12.9699 13.7L11.3699 11.3L8.16992 14.5"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
        ...
        >
          <path
            d="M16.8599 2H8.47992C4.83992 2 2.66992 4.17 2.66992 7.81V16.18C2.66992 19.83 4.83992 22 8.47992 22H16.8499C20.4899 22 22.6599 19.83 22.6599 16.19V7.81C22.6699 4.17 20.4999 2 16.8599 2ZM17.5499 11.53C17.5499 11.92 17.2399 12.23 16.8499 12.23C16.4599 12.23 16.1499 11.92 16.1499 11.53V11.35L13.4299 14.07C13.2799 14.22 13.0799 14.29 12.8699 14.27C12.6599 14.25 12.4699 14.14 12.3599 13.96L11.3399 12.44L8.95992 14.82C8.81992 14.96 8.64992 15.02 8.46992 15.02C8.28992 15.02 8.10992 14.95 7.97992 14.82C7.70992 14.55 7.70992 14.11 7.97992 13.83L10.9599 10.85C11.1099 10.7 11.3099 10.63 11.5199 10.65C11.7299 10.67 11.9199 10.78 12.0299 10.96L13.0499 12.48L15.1599 10.37H14.9799C14.5899 10.37 14.2799 10.06 14.2799 9.67C14.2799 9.28 14.5899 8.97 14.9799 8.97H16.8399C16.9299 8.97 17.0199 8.99 17.1099 9.02C17.2799 9.09 17.4199 9.23 17.4899 9.4C17.5299 9.49 17.5399 9.58 17.5399 9.67V11.53H17.5499Z"
            fill="currentColor"
          />
        </svg>
      )}
