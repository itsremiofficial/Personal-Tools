...
const IconMessage: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M9.16992 19H8.66992C4.66992 19 2.66992 18 2.66992 13V8C2.66992 4 4.66992 2 8.66992 2H16.6699C20.6699 2 22.6699 4 22.6699 8V13C22.6699 17 20.6699 19 16.6699 19H16.1699C15.8599 19 15.5599 19.15 15.3699 19.4L13.8699 21.4C13.2099 22.28 12.1299 22.28 11.4699 21.4L9.96992 19.4C9.80992 19.18 9.43992 19 9.16992 19Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M2.66992 12.97V6.99C2.66992 4.23 4.90992 2 7.66992 2H17.6699C20.4299 2 22.6699 4.23 22.6699 6.99V13.97C22.6699 16.72 20.4299 18.95 17.6699 18.95H16.1699C15.8599 18.95 15.5599 19.1 15.3699 19.35L13.8699 21.34C13.2099 22.22 12.1299 22.22 11.4699 21.34L9.96992 19.35C9.80992 19.13 9.44992 18.95 9.16992 18.95H7.66992C4.90992 18.95 2.66992 16.72 2.66992 13.97V12.97Z"
            fill="currentColor"
          />
          <path
...
(IconMessage as IconComponent).keywords = [
  "message",
  "subject matter",
  "substance",
  "content",
...
export default IconMessage as IconComponent;
