      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M9.83984 14.8299L15.4998 9.16992"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M15.4998 14.8299L9.83984 9.16992"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M13.7303 12L16.0303 9.7C16.3203 9.41 16.3203 8.93 16.0303 8.64C15.7403 8.35 15.2603 8.35 14.9703 8.64L12.6703 10.94L10.3703 8.64C10.0803 8.35 9.60027 8.35 9.31027 8.64C9.02027 8.93 9.02027 9.41 9.31027 9.7L11.6103 12L9.31027 14.3C9.02027 14.59 9.02027 15.07 9.31027 15.36C9.46027 15.51 9.65027 15.58 9.84027 15.58C10.0303 15.58 10.2203 15.51 10.3703 15.36L12.6703 13.06L14.9703 15.36C15.1203 15.51 15.3103 15.58 15.5003 15.58C15.6903 15.58 15.8803 15.51 16.0303 15.36C16.3203 15.07 16.3203 14.59 16.0303 14.3L13.7303 12Z"
            fill="currentColor"
          />
        </svg>
      ) : (
