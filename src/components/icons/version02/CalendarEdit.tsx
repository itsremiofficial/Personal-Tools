...
const IconCalendarEdit: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M19.88 15.77L16.34 19.31C16.2 19.45 16.07 19.71 16.04 19.9L15.85 21.25C15.78 21.74 16.12 22.0801 16.61 22.0101L17.96 21.82C18.15 21.79 18.42 21.66 18.55 21.52L22.09 17.9801C22.7 17.3701 22.99 16.6601 22.09 15.7601C21.2 14.8701 20.49 15.16 19.88 15.77Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
          ...
          />
          <path
            d="M19.3701 16.28C19.6701 17.36 20.5101 18.2 21.5901 18.5"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
          ...
          />
          <path
            d="M12.6699 22H8.66992C5.16992 22 3.66992 20 3.66992 17V8.5C3.66992 5.5 5.16992 3.5 8.66992 3.5H16.6699C20.1699 3.5 21.6699 5.5 21.6699 8.5V12"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
...
(IconCalendarEdit as IconComponent).keywords = [
  "calendar",
  "edit",
  "timeline",
  "chronology",
...
export default IconCalendarEdit as IconComponent;
