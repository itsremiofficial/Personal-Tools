      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M7.16992 16L10.6699 8L14.2699 16"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
        ...
        >
          ...
          <path
            ...
            d="M16.8599 2H8.47992C4.83992 2 2.66992 4.17 2.66992 7.81V16.18C2.66992 19.82 4.83992 21.99 8.47992 21.99H16.8499C20.4899 21.99 22.6599 19.82 22.6599 16.18V7.81C22.6699 4.17 20.4999 2 16.8599 2Z"
            fill="currentColor"
          />
          <path
            d="M11.5599 7.79997C11.4599 7.50997 11.1899 7.29996 10.8799 7.28996C10.5599 7.26996 10.2799 7.44997 10.1599 7.72997L6.62991 15.66C6.45991 16.04 6.62991 16.48 7.00991 16.65C7.38991 16.82 7.82991 16.65 7.99991 16.27L8.97991 14.07H12.0599L12.7699 16.2C12.8699 16.51 13.1699 16.71 13.4799 16.71C13.5599 16.71 13.6399 16.7 13.7199 16.67C14.1099 16.54 14.3199 16.11 14.1899 15.72L11.5599 7.79997ZM9.64991 12.57L10.7499 10.1L11.5699 12.57H9.64991Z"
            fill="currentColor"
          />
          <path
            d="M17.02 9.92999C16.61 9.92999 16.27 10.27 16.27 10.68V15.97C16.27 16.38 16.61 16.72 17.02 16.72C17.43 16.72 17.77 16.38 17.77 15.97V10.68C17.77 10.26 17.43 9.92999 17.02 9.92999Z"
            fill="currentColor"
          />
          <path
            d="M17.94 7.65C17.89 7.53 17.82 7.42 17.72 7.33C17.45 7.05 17 6.96 16.63 7.11C16.51 7.16 16.4 7.23 16.31 7.33C16.22 7.42 16.15 7.53 16.09 7.65C16.04 7.77 16.02 7.9 16.02 8.03C16.02 8.17 16.04 8.29 16.09 8.42C16.14 8.54 16.22 8.65001 16.31 8.74001C16.5 8.93001 16.75 9.03 17.02 9.03C17.15 9.03 17.28 9.01001 17.4 8.96001C17.52 8.91001 17.63 8.83001 17.72 8.74001C17.82 8.65001 17.89 8.54 17.94 8.42C17.99 8.3 18.02 8.17 18.02 8.03C18.02 7.9 17.99 7.77 17.94 7.65Z"
            fill="currentColor"
          />
        </svg>
      ) : (
