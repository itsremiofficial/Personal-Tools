      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            ...
            />
            <path
              d="M8.61993 9.89999C9.69689 9.89999 10.5699 9.02697 10.5699 7.95001C10.5699 6.87306 9.69689 6 8.61993 6C7.54298 6 6.66992 6.87306 6.66992 7.95001C6.66992 9.02697 7.54298 9.89999 8.61993 9.89999Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M8.46991 17.9999C9.46402 17.9999 10.2699 17.194 10.2699 16.1999C10.2699 15.2058 9.46402 14.3999 8.46991 14.3999C7.4758 14.3999 6.66992 15.2058 6.66992 16.1999C6.66992 17.194 7.4758 17.9999 8.46991 17.9999Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M16.8698 17.9999C17.8639 17.9999 18.6698 17.194 18.6698 16.1999C18.6698 15.2058 17.8639 14.3999 16.8698 14.3999C15.8757 14.3999 15.0698 15.2058 15.0698 16.1999C15.0698 17.194 15.8757 17.9999 16.8698 17.9999Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M8.5498 10.2C8.8198 11.25 9.77979 12.0299 10.9098 12.0199L12.9698 12.0099C14.5398 11.9999 15.8798 13.01 16.3698 14.42"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
