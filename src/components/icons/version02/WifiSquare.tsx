      ...
      {!fill ? (
        ...
        >
          <path
            ...
            d="M6.66992 9.96001C10.2999 7.15001 15.0399 7.15001 18.6699 9.96001"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M8.26953 13.05C10.9395 10.99 14.4095 10.99 17.0795 13.05"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M10.4697 16.14C11.7997 15.11 13.5397 15.11 14.8697 16.14"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M18.6695 10.71C18.5095 10.71 18.3495 10.66 18.2095 10.55C14.8395 7.95 10.4895 7.95 7.12946 10.55C6.79946 10.8 6.32946 10.74 6.07946 10.42C5.82946 10.09 5.88946 9.62 6.20946 9.37C10.1295 6.34 15.1995 6.34 19.1295 9.37C19.4595 9.62 19.5195 10.09 19.2595 10.42C19.1195 10.61 18.8895 10.71 18.6695 10.71Z"
            fill="currentColor"
          />
          <path
            d="M17.0693 13.8C16.9093 13.8 16.7493 13.75 16.6093 13.64C14.2093 11.79 11.1193 11.79 8.71931 13.64C8.38931 13.89 7.91931 13.83 7.66931 13.51C7.41931 13.19 7.47931 12.71 7.79931 12.46C10.7493 10.18 14.5693 10.18 17.5193 12.46C17.8493 12.71 17.9093 13.18 17.6493 13.51C17.5193 13.7 17.2993 13.8 17.0693 13.8Z"
            fill="currentColor"
          />
          <path
            d="M14.8695 16.89C14.7095 16.89 14.5495 16.84 14.4095 16.73C13.3495 15.91 11.9795 15.91 10.9195 16.73C10.5895 16.98 10.1195 16.92 9.8695 16.6C9.6195 16.27 9.67951 15.8 9.99951 15.55C11.5895 14.32 13.7295 14.32 15.3195 15.55C15.6495 15.8 15.7095 16.27 15.4495 16.6C15.3195 16.79 15.0995 16.89 14.8695 16.89Z"
            fill="currentColor"
          />
        </svg>
      ) : (
