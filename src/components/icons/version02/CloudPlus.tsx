...
const IconCloudPlus: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M14.1399 14.3899H11.1999C9.92992 14.3899 9.16992 15.1499 9.16992 16.4199V19.3599C9.16992 20.6299 9.92992 21.3899 11.1999 21.3899H14.1399C15.4099 21.3899 16.1699 20.6299 16.1699 19.3599V16.4199C16.1699 15.1499 15.4099 14.3899 14.1399 14.3899ZM15.0799 18.3199C14.9799 18.4199 14.8299 18.4899 14.6699 18.4999H13.2599L13.2699 19.8899C13.2599 20.0599 13.1999 20.1999 13.0799 20.3199C12.9799 20.4199 12.8299 20.4899 12.6699 20.4899C12.3399 20.4899 12.0699 20.2199 12.0699 19.8899V18.4899L10.6699 18.4999C10.3399 18.4999 10.0699 18.2199 10.0699 17.8899C10.0699 17.5599 10.3399 17.2899 10.6699 17.2899L12.0699 17.2999V15.8999C12.0699 15.5699 12.3399 15.2899 12.6699 15.2899C12.9999 15.2899 13.2699 15.5699 13.2699 15.8999L13.2599 17.2899H14.6699C14.9999 17.2899 15.2699 17.5599 15.2699 17.8899C15.2599 18.0599 15.1899 18.1999 15.0799 18.3199Z"
            fill="currentColor"
          />
          <path
...
(IconCloudPlus as IconComponent).keywords = [
  "cloud",
  "plus",
  "fog",
  "mist",
...
export default IconCloudPlus as IconComponent;
