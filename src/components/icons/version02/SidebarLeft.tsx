    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M15.6398 9.43994L13.0798 11.9999L15.6398 14.5599"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M9.38989 2V22H8.47989C8.27989 22 8.07989 21.99 7.88989 21.98V2.03C8.07989 2.01 8.27989 2 8.47989 2H9.38989Z"
            fill="currentColor"
          />
          <path
            d="M15.64 15.3099C15.45 15.3099 15.26 15.2399 15.11 15.0899L12.55 12.5299C12.26 12.2399 12.26 11.7599 12.55 11.4699L15.11 8.90988C15.4 8.61988 15.88 8.61988 16.17 8.90988C16.46 9.19988 16.46 9.67988 16.17 9.96988L14.15 11.9999L16.18 14.0299C16.47 14.3199 16.47 14.7999 16.18 15.0899C16.03 15.2399 15.84 15.3099 15.64 15.3099Z"
            fill="currentColor"
          />
        </svg>
      ) : (
