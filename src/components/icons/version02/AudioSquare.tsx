      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M10.2899 17.3C11.4608 17.3 12.4099 16.3508 12.4099 15.18C12.4099 14.0091 11.4608 13.06 10.2899 13.06C9.11907 13.06 8.16992 14.0091 8.16992 15.18C8.16992 16.3508 9.11907 17.3 10.2899 17.3Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            />
            <path
              d="M13.8002 6.77004L16.1401 7.55C16.7101 7.74 17.1702 8.38 17.1702 8.98V9.59999C17.1702 10.41 16.5402 10.86 15.7802 10.6L13.4402 9.82002C12.8702 9.63002 12.4102 8.99003 12.4102 8.39003V7.77004C12.4102 6.97004 13.0302 6.51004 13.8002 6.77004Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
