...
const IconSetting: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M3.66992 9.10986V14.8799C3.66992 16.9999 3.66992 16.9999 5.66992 18.3499L11.1699 21.5299C11.9999 22.0099 13.3499 22.0099 14.1699 21.5299L19.6699 18.3499C21.6699 16.9999 21.6699 16.9999 21.6699 14.8899V9.10986C21.6699 6.99986 21.6699 6.99986 19.6699 5.64986L14.1699 2.46986C13.3499 1.98986 11.9999 1.98986 11.1699 2.46986L5.66992 5.64986C3.66992 6.99986 3.66992 6.99986 3.66992 9.10986Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
...
(IconSetting as IconComponent).keywords = [
  "setting",
  "scene",
  "stage setting",
  "mise en scene",
...
export default IconSetting as IconComponent;
