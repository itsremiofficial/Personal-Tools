...
(IconVideoOctagon as IconComponentType).keywords = [
  "video",
  "octagon",
  "tv",
  "television",
...
export default IconVideoOctagon as IconComponentType;