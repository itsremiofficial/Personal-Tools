...
const IconArrowSquareDown: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          ...
          <path
            ...
            d="M9.14014 10.64L12.6701 14.16L16.2001 10.64"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
...
(IconArrowSquareDown as IconComponent).keywords = [
  "arrow",
  "square",
  "down",
  "pointer",
...
export default IconArrowSquareDown as IconComponent;
