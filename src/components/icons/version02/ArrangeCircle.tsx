...
const IconArrangeCircle: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M14.4897 6.84998L17.5297 9.88998"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M18.0598 9.25986L15.0197 6.21988C14.9497 6.14988 14.8697 6.09988 14.7797 6.05988C14.5997 5.97988 14.3897 5.97988 14.2097 6.05988C14.0297 6.13988 13.8797 6.27988 13.7997 6.46988C13.7597 6.55988 13.7397 6.65986 13.7397 6.75986V17.0699C13.7397 17.4799 14.0797 17.8199 14.4897 17.8199C14.8997 17.8199 15.2397 17.4799 15.2397 17.0699V8.56989L16.9997 10.3299C17.1497 10.4799 17.3397 10.5499 17.5297 10.5499C17.7197 10.5499 17.9098 10.4799 18.0598 10.3299C18.3498 10.0199 18.3498 9.54986 18.0598 9.25986Z"
            fill="currentColor"
          />
          <path
            d="M11.6 6.74988C11.6 6.33988 11.26 5.99988 10.85 5.99988C10.44 5.99988 10.1 6.33988 10.1 6.74988V15.2499L8.34003 13.4899C8.05003 13.1999 7.57 13.1999 7.28 13.4899C6.99 13.7799 6.99 14.2599 7.28 14.5499L10.32 17.5899C10.39 17.6599 10.47 17.7099 10.56 17.7499C10.65 17.7899 10.75 17.8099 10.85 17.8099C10.95 17.8099 11.04 17.7899 11.14 17.7499C11.32 17.6699 11.47 17.5299 11.55 17.3399C11.59 17.2499 11.61 17.1499 11.61 17.0499V6.74988H11.6Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconArrangeCircle as IconComponent).keywords = [
  "arrange",
  "circle",
  "order",
  "put",
...
export default IconArrangeCircle as IconComponent;
