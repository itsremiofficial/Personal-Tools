...
const IconForwardSquare: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M15.6699 15.38H10.7499C9.04992 15.38 7.66992 14 7.66992 12.3C7.66992 10.6 9.04992 9.21997 10.7499 9.21997H17.5199"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
            ...
            />
            <path
              d="M16.1001 10.77L17.6701 9.18999L16.1001 7.62"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M18.1999 8.66006L16.6299 7.09006C16.3399 6.80006 15.8599 6.80006 15.5699 7.09006C15.2799 7.38006 15.2799 7.86006 15.5699 8.15006L15.8999 8.48006H10.7499C8.63992 8.48006 6.91992 10.2001 6.91992 12.3101C6.91992 14.4201 8.63992 16.1401 10.7499 16.1401H15.6699C16.0799 16.1401 16.4199 15.8001 16.4199 15.3901C16.4199 14.9801 16.0799 14.6401 15.6699 14.6401H10.7499C9.46992 14.6401 8.41992 13.6001 8.41992 12.3101C8.41992 11.0201 9.45992 9.98006 10.7499 9.98006H15.8299L15.5699 10.2401C15.2799 10.5301 15.2799 11.0101 15.5699 11.3001C15.7199 11.4501 15.9099 11.5201 16.0999 11.5201C16.2899 11.5201 16.4799 11.4501 16.6299 11.3001L18.1999 9.73006C18.4899 9.43006 18.4899 8.96006 18.1999 8.66006Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconForwardSquare as IconComponent).keywords = [
  "forward",
  "square",
  "frontwards",
  "ahead",
...
export default IconForwardSquare as IconComponent;
