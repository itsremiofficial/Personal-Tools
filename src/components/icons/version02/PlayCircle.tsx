      ...
      {!fill ? (
        ...
        >
          ...
          <path
            ...
            d="M9.41016 12.23V10.56C9.41016 8.48 10.8802 7.63 12.6802 8.67L14.1302 9.51L15.5802 10.35C17.3802 11.39 17.3802 13.09 15.5802 14.13L14.1302 14.97L12.6802 15.81C10.8802 16.85 9.41016 16 9.41016 13.92V12.23Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M15.6403 10.23L12.7403 8.56C12.0203 8.14 11.1503 8.14 10.4303 8.56C9.71027 8.98 9.28027 9.72 9.28027 10.56V13.91C9.28027 14.74 9.71027 15.49 10.4303 15.91C10.7903 16.12 11.1903 16.22 11.5803 16.22C11.9803 16.22 12.3703 16.12 12.7303 15.91L15.6303 14.24C16.3503 13.82 16.7803 13.08 16.7803 12.24C16.8003 11.4 16.3703 10.65 15.6403 10.23Z"
            fill="currentColor"
          />
        </svg>
      ) : (
