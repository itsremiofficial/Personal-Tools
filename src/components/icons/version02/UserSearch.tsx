...
const IconUserSearch: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          ...
          <path
            ...
            d="M4.08008 22C4.08008 18.13 7.93011 15 12.6701 15"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M23.4399 20.68L22.6799 19.92C23.0799 19.32 23.3099 18.6 23.3099 17.83C23.3099 15.72 21.5999 14.01 19.4899 14.01C17.3799 14.01 15.6699 15.72 15.6699 17.83C15.6699 19.94 17.3799 21.65 19.4899 21.65C20.2599 21.65 20.9799 21.42 21.5799 21.02L22.3399 21.78C22.4899 21.93 22.6899 22.01 22.8899 22.01C23.0899 22.01 23.2899 21.93 23.4399 21.78C23.7499 21.47 23.7499 20.98 23.4399 20.68Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconUserSearch as IconComponent).keywords = [
  "user",
  "search",
  "exploiter",
  "enjoyer",
...
export default IconUserSearch as IconComponent;
