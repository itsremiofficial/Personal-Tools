    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            d="M19.4699 19.7L17.5699 21.6C17.0499 22.12 16.1899 22.12 15.6599 21.6L14.0799 20.01C13.5599 19.49 13.5599 18.63 14.0799 18.1L15.9799 16.21L19.4699 19.7Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M22.2797 16.9L19.4697 19.7099L15.9697 16.2099L18.7797 13.39C19.2997 12.87 20.1697 12.87 20.6897 13.39L22.2697 14.98C22.7997 15.51 22.7997 16.38 22.2797 16.9Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M16 8.60986V14.8699C16 15.2499 15.69 15.5499 15.32 15.5499H9.06006V8.60986H16Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.4" : "1"}
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M20.4697 20.7L18.5697 22.6099C18.0497 23.1299 17.1897 23.1299 16.6497 22.6099L15.0697 21.02C14.5497 20.49 14.5497 19.6399 15.0697 19.0999L16.9797 17.21L20.4697 20.7Z"
            fill="currentColor"
          />
          <path
            d="M23.28 17.9L20.47 20.7L16.98 17.21L19.78 14.39C20.31 13.87 21.17 13.87 21.7 14.39L23.28 15.98C23.8 16.51 23.8 17.38 23.28 17.9Z"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          <path
            d="M19.4697 20.7L17.5697 22.61C17.0497 23.13 16.1897 23.13 15.6497 22.61L14.0697 21.02C13.5497 20.49 13.5497 19.64 14.0697 19.1L15.9797 17.21L19.4697 20.7Z"
            fill="currentColor"
          />
          <path
            d="M23.28 16.9L20.47 19.7L16.98 16.21L19.78 13.39C20.31 12.87 21.17 12.87 21.7 13.39L23.28 14.98C23.8 15.51 23.8 16.38 23.28 16.9Z"
            fill="currentColor"
          />
          <path
