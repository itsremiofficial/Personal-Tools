      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M17.8198 13.8201L14.7798 16.86"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M18.5198 13.5301C18.4398 13.3501 18.2998 13.2001 18.1098 13.1201C18.0198 13.0801 17.9198 13.0601 17.8198 13.0601H7.50977C7.09977 13.0601 6.75977 13.4001 6.75977 13.8101C6.75977 14.2201 7.09977 14.5601 7.50977 14.5601H16.0098L14.2498 16.3201C13.9598 16.6101 13.9598 17.0901 14.2498 17.3801C14.3998 17.5301 14.5898 17.6001 14.7798 17.6001C14.9698 17.6001 15.1598 17.5301 15.3098 17.3801L18.3498 14.3401C18.4198 14.2701 18.4698 14.1901 18.5098 14.1001C18.5898 13.9201 18.5898 13.7101 18.5198 13.5301Z"
            fill="currentColor"
          />
          <path
            d="M17.8198 9.42996H9.31977L11.0798 7.66998C11.3698 7.37998 11.3698 6.89996 11.0798 6.60996C10.7898 6.31996 10.3098 6.31996 10.0198 6.60996L6.97977 9.64996C6.90977 9.71996 6.85977 9.79999 6.81977 9.88999C6.73977 10.07 6.73977 10.28 6.81977 10.46C6.89977 10.64 7.03977 10.79 7.22977 10.87C7.31977 10.91 7.41978 10.93 7.51978 10.93H17.8298C18.2398 10.93 18.5798 10.59 18.5798 10.18C18.5798 9.76996 18.2398 9.42996 17.8198 9.42996Z"
            fill="currentColor"
          />
        </svg>
      ) : (
