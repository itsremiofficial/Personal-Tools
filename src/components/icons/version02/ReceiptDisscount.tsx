...
const IconReceiptDisscount: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M15.6699 14C15.1099 14 14.6699 13.55 14.6699 13C14.6699 12.45 15.1199 12 15.6699 12C16.2199 12 16.6699 12.45 16.6699 13C16.6699 13.55 16.2299 14 15.6699 14Z"
            fill="currentColor"
          />
          <path
            d="M9.66992 9C9.10992 9 8.66992 8.55 8.66992 8C8.66992 7.45 9.11992 7 9.66992 7C10.2199 7 10.6699 7.45 10.6699 8C10.6699 8.55 10.2299 9 9.66992 9Z"
            fill="currentColor"
          />
          <path
            d="M9.30023 14.55C9.11023 14.55 8.92023 14.48 8.77023 14.33C8.48023 14.04 8.48023 13.56 8.77023 13.27L15.5002 6.54001C15.7902 6.25001 16.2702 6.25001 16.5602 6.54001C16.8502 6.83001 16.8502 7.31001 16.5602 7.60001L9.83023 14.33C9.69023 14.48 9.49023 14.55 9.30023 14.55Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconReceiptDisscount as IconComponent).keywords = [
  "receipt",
  "disscount",
  "receiving",
  "reception",
...
export default IconReceiptDisscount as IconComponent;
