      ...
      {!fill ? (
        ...
        >
          <path
            ...
            d="M12.6707 14H13.6707C14.7707 14 15.6707 13.1 15.6707 12V2H6.67065C5.17065 2 3.86066 2.82999 3.18066 4.04999"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          ...
          />
          <path
            d="M2.6709 17C2.6709 18.66 4.0109 20 5.6709 20H6.6709C6.6709 18.9 7.5709 18 8.6709 18C9.7709 18 10.6709 18.9 10.6709 20H14.6709C14.6709 18.9 15.5709 18 16.6709 18C17.7709 18 18.6709 18.9 18.6709 20H19.6709C21.3309 20 22.6709 18.66 22.6709 17V14H19.6709C19.1209 14 18.6709 13.55 18.6709 13V10C18.6709 9.45 19.1209 9 19.6709 9H20.9609L19.2509 6.01001C18.8909 5.39001 18.2309 5 17.5109 5H15.6709V12C15.6709 13.1 14.7709 14 13.6709 14H12.6709"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M14.6699 2H6.66992C4.71992 2 3.09994 3.4 2.74994 5.25H7.66992C8.07992 5.25 8.41992 5.59 8.41992 6C8.41992 6.41 8.07992 6.75 7.66992 6.75H2.66992V8.25H5.66992C6.07992 8.25 6.41992 8.59 6.41992 9C6.41992 9.41 6.07992 9.75 5.66992 9.75H2.66992V11.25H3.66992C4.07992 11.25 4.41992 11.59 4.41992 12C4.41992 12.41 4.07992 12.75 3.66992 12.75H2.66992V14H13.6699C14.7699 14 15.6699 13.1 15.6699 12V3C15.6699 2.45 15.2199 2 14.6699 2Z"
            fill="currentColor"
          />
          <path
            d="M2.74994 5.25H1.66992C1.25992 5.25 0.919922 5.59 0.919922 6C0.919922 6.41 1.25992 6.75 1.66992 6.75H2.66992V6C2.66992 5.74 2.69994 5.49 2.74994 5.25Z"
            fill="currentColor"
          />
          <path
            d="M1.66992 8.25C1.25992 8.25 0.919922 8.59 0.919922 9C0.919922 9.41 1.25992 9.75 1.66992 9.75H2.66992V8.25H1.66992Z"
            fill="currentColor"
          />
          <path
            d="M1.66992 11.25C1.25992 11.25 0.919922 11.59 0.919922 12C0.919922 12.41 1.25992 12.75 1.66992 12.75H2.66992V11.25H1.66992Z"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          ...
          />
          <path
            d="M13.7509 2H6.3609C4.5709 2 3.0709 3.28 2.7409 4.98H7.1109C7.4909 4.98 7.7909 5.29 7.7909 5.67C7.7909 6.05 7.4909 6.35 7.1109 6.35H2.6709V7.73H5.2709C5.6509 7.73 5.9609 8.04 5.9609 8.42C5.9609 8.8 5.6509 9.1 5.2709 9.1H2.6709V10.48H3.4409C3.8209 10.48 4.1309 10.79 4.1309 11.17C4.1309 11.55 3.8209 11.85 3.4409 11.85H2.6709V12.08C2.6709 12.63 3.1209 13.08 3.6709 13.08H12.8209C13.8409 13.08 14.6709 12.25 14.6709 11.23V2.92C14.6709 2.41 14.2609 2 13.7509 2Z"
            fill="currentColor"
          />
          <path
            d="M2.7409 4.97998H2.5909H1.6109C1.2309 4.97998 0.920898 5.28998 0.920898 5.66998C0.920898 6.04998 1.2309 6.34998 1.6109 6.34998H2.5209H2.6709V5.68998C2.6709 5.44998 2.7009 5.20998 2.7409 4.97998Z"
            fill="currentColor"
          />
          <path
            d="M2.5209 7.72998H1.6109C1.2309 7.72998 0.920898 8.03998 0.920898 8.41998C0.920898 8.79998 1.2309 9.09998 1.6109 9.09998H2.5209H2.6709V7.72998H2.5209Z"
            fill="currentColor"
          />
          <path
            d="M2.5209 10.48H1.6109C1.2309 10.48 0.920898 10.79 0.920898 11.17C0.920898 11.55 1.2309 11.85 1.6109 11.85H2.5209H2.6709V10.48H2.5209Z"
            fill="currentColor"
          />
        </svg>
      )}
