...
const IconCloudSnow: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconCloudSnow as IconComponent).keywords = [
  "cloud",
  "snow",
  "fog",
  "mist",
...
export default IconCloudSnow as IconComponent;
