...
const IconLocationCross: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M15.2004 12.4202L13.7504 10.9702L15.1504 9.57018C15.4404 9.28018 15.4404 8.80018 15.1504 8.51018C14.8604 8.22018 14.3804 8.22018 14.0904 8.51018L12.6904 9.91018L11.2404 8.46018C10.9504 8.17018 10.4704 8.17018 10.1804 8.46018C9.89035 8.75018 9.89035 9.23018 10.1804 9.52018L11.6304 10.9702L10.1404 12.4602C9.85035 12.7502 9.85035 13.2302 10.1404 13.5202C10.2904 13.6702 10.4804 13.7402 10.6704 13.7402C10.8604 13.7402 11.0504 13.6702 11.2004 13.5202L12.6904 12.0302L14.1404 13.4802C14.2904 13.6302 14.4804 13.7002 14.6704 13.7002C14.8604 13.7002 15.0504 13.6302 15.2004 13.4802C15.4904 13.1902 15.4904 12.7202 15.2004 12.4202Z"
            fill="currentColor"
          />
          <path
