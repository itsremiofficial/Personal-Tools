...
(IconMessageNotif as IconComponentType).keywords = [
  "message",
  "notif",
  "subject matter",
  "substance",
...
export default IconMessageNotif as IconComponentType;