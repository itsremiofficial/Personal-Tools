  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M22.6699 11.0699V16.6499C22.6699 19.5999 20.2699 21.9999 17.3199 21.9999H8.01992C5.06992 21.9999 2.66992 19.5999 2.66992 16.6499V9.43994H22.4099C22.5599 9.88994 22.6399 10.3499 22.6599 10.8399C22.6699 10.9099 22.6699 10.9999 22.6699 11.0699Z"
            fill="currentColor"
          />
          <path
        ...
        >
          ...
          />
          <path
            d="M21.6533 10.7498C22.2043 10.7498 22.6514 11.1954 22.6533 11.7464L22.6699 16.65C22.6699 19.6 20.2699 22 17.3199 22H8.01992C5.06992 22 2.66992 19.6 2.66992 16.65V11.75C2.66992 11.1977 3.11763 10.75 3.66991 10.75L21.6533 10.7498Z"
            fill="currentColor"
          />
        </svg>
      )}
