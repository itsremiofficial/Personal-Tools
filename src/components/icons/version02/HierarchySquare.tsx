...
const IconHierarchySquare: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M17.1198 14.4V8.5C17.1198 7.95 16.6698 7.5 16.1198 7.5H13.2197"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
            ...
            />
            <path
              d="M14.7199 6L12.9199 7.5L14.7199 9"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            />
            <path
              d="M8.36993 9.89999C9.44689 9.89999 10.3199 9.02697 10.3199 7.95001C10.3199 6.87306 9.44689 6 8.36993 6C7.29298 6 6.41992 6.87306 6.41992 7.95001C6.41992 9.02697 7.29298 9.89999 8.36993 9.89999Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M8.21991 17.9999C9.21402 17.9999 10.0199 17.194 10.0199 16.1999C10.0199 15.2058 9.21402 14.3999 8.21991 14.3999C7.2258 14.3999 6.41992 15.2058 6.41992 16.1999C6.41992 17.194 7.2258 17.9999 8.21991 17.9999Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M17.1198 17.9999C18.1139 17.9999 18.9198 17.194 18.9198 16.1999C18.9198 15.2058 18.1139 14.3999 17.1198 14.3999C16.1257 14.3999 15.3198 15.2058 15.3198 16.1999C15.3198 17.194 16.1257 17.9999 17.1198 17.9999Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
