...
const IconBatteryFull2: FC<IconProps> = ({ className, fill = false, duotone = true, width = '1.5' }) => {
  return (
    <>
      {!fill ? (
...
(IconBatteryFull2 as IconComponentType).keywords = [
  "battery",
  "full",
  "2",
  "bombardment",
...
export default IconBatteryFull2 as IconComponentType;