...
(IconCalendar as IconComponentType).keywords = [
  "calendar",
  "timeline",
  "chronology",
  "rota",
...
export default IconCalendar as IconComponentType;