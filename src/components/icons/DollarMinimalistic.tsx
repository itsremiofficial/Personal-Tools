...
(IconDollarMinimalistic as IconComponentType).keywords = [
  "dollar",
  "minimalistic",
  "dollar bill",
  "dollar sign",
...
export default IconDollarMinimalistic as IconComponentType;