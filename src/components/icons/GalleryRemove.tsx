...
(IconGalleryRemove as IconComponentType).keywords = [
  "gallery",
  "remove",
  "art gallery",
  "heading",
...
export default IconGalleryRemove as IconComponentType;