...
(IconDocumentText1 as IconComponentType).keywords = [
  "document",
  "text",
  "1",
  "papers",
...
export default IconDocumentText1 as IconComponentType;