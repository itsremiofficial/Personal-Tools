...
const IconBell: FC<IconProps> = ({ className, fill = false, duotone = true, width = '1.5' }) => {
  return (
    <>
      {!fill ? (
...
(IconBell as IconComponentType).keywords = [
  "bell",
  "gong",
  "chime",
  "campana",
...
export default IconBell as IconComponentType;