...
(IconListArrowUpMinimalistic as IconComponentType).keywords = [
  "list",
  "arrow",
  "up",
  "minimalistic",
...
export default IconListArrowUpMinimalistic as IconComponentType;