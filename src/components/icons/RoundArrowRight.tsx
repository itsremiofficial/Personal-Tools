...
(IconRoundArrowRight as IconComponentType).keywords = [
  "round",
  "arrow",
  "right",
  "orbicular",
...
export default IconRoundArrowRight as IconComponentType;