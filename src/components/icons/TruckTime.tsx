...
(IconTruckTime as IconComponentType).keywords = [
  "truck",
  "time",
  "hand truck",
  "motortruck",
...
export default IconTruckTime as IconComponentType;