...
(IconReceipt as IconComponentType).keywords = [
  "receipt",
  "receiving",
  "reception",
  "acknowledge",
...
export default IconReceipt as IconComponentType;