...
(IconCalendarSearch as IconComponentType).keywords = [
  "calendar",
  "search",
  "timeline",
  "chronology",
...
export default IconCalendarSearch as IconComponentType;