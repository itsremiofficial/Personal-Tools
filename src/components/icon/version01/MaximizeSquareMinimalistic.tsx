...
(IconMaximizeSquareMinimalistic as IconComponentType).keywords = [
  "maximize",
  "square",
  "minimalistic",
  "max",
...
export default IconMaximizeSquareMinimalistic as IconComponentType;