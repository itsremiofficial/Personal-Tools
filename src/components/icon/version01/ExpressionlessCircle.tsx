...
(IconExpressionlessCircle as IconComponentType).keywords = [
  "expressionless",
  "circle",
  "impassive",
  "unexpressive",
...
export default IconExpressionlessCircle as IconComponentType;