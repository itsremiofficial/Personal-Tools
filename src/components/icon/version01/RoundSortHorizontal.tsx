...
const IconRoundSortHorizontal: FC<IconProps> = ({ className, fill = false, duotone = true, width = '1.5' }) => {
  return (
    <>
      {!fill ? (
...
(IconRoundSortHorizontal as IconComponentType).keywords = [
  "round",
  "sort",
  "horizontal",
  "orbicular",
...
export default IconRoundSortHorizontal as IconComponentType;