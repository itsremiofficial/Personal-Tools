...
(IconShieldMinus as IconComponentType).keywords = [
  "shield",
  "minus",
  "buckler",
  "screen",
...
export default IconShieldMinus as IconComponentType;