      ...
      >
        ...
        {active ? (
          <motion.span
            layoutId={layoutId}
            className={cn(
              "absolute -bottom-px left-0 right-0 h-px bg-primary/15",
              indicatorClassName,
            )}
          />
        ) : null}
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        onClick={() => setValue(value)}
        className={cn(
          "cursor-pointer relative z-10 inline-flex items-center justify-center whitespace-nowrap bg-transparent px-4.5 py-3 text-sm font-medium outline-none",
