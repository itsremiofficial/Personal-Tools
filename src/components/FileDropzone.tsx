...
export const FileDropzone = React.memo(
  ({
    ...
    return (
      <Card
        className={cn("p-2 bg-muted/20 rounded-3xl flex flex-col gap-6 grow")}
      >
        <div
          {...getRootProps()}
          className={cn(
            ...
            "hover:bg-muted/70",
            isDragActive && "border-border bg-accent/70",
        ...
        >
          ...
          <label
            className={cn(
              ...
              isDragActive && "!text-foreground border-muted-foreground/60",
            )}
          >
            {label}
          </label>
