...
(IconListCrossMinimalistic as IconComponentType).keywords = [
  "list",
  "cross",
  "minimalistic",
  "tilt",
...
export default IconListCrossMinimalistic as IconComponentType;