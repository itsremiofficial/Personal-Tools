...
(IconMapPointSearch as IconComponentType).keywords = [
  "map",
  "point",
  "search",
  "map out",
...
export default IconMapPointSearch as IconComponentType;