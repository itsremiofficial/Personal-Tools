...
const IconMagniferZoomInMinimalistic: FC<IconProps> = ({ className, fill = false, duotone = true, width = '1.5' }) => {
  return (
    <>
      {!fill ? (
...
(IconMagniferZoomInMinimalistic as IconComponentType).keywords = [
  "magnifer",
  "zoom",
  "in",
  "minimalistic",
...
export default IconMagniferZoomInMinimalistic as IconComponentType;