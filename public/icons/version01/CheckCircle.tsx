...
const IconCheckCircle: FC<IconProps> = ({ className, fill = false, duotone = true, width = '1.5' }) => {
  return (
    <>
      {!fill ? (
...
(IconCheckCircle as IconComponentType).keywords = [
  "check",
  "circle",
  "match",
  "hitch",
...
export default IconCheckCircle as IconComponentType;