    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M9.44661 14.3975C9.11385 14.1508 8.64413 14.2206 8.39747 14.5534C8.15082 14.8862 8.22062 15.3559 8.55339 15.6025C9.5258 16.3233 10.715 16.75 12 16.75C13.285 16.75 14.4742 16.3233 15.4466 15.6025C15.7794 15.3559 15.8492 14.8862 15.6025 14.5534C15.3559 14.2206 14.8862 14.1508 14.5534 14.3975C13.825 14.9373 12.9459 15.25 12 15.25C11.0541 15.25 10.175 14.9373 9.44661 14.3975Z"
            fill="currentColor"
          />
          <path
            d="M16 9.5C16 10.3284 15.5523 11 15 11C14.4477 11 14 10.3284 14 9.5C14 8.67157 14.4477 8 15 8C15.5523 8 16 8.67157 16 9.5Z"
            fill="currentColor"
          />
          <path
            d="M9 11C9.55228 11 10 10.3284 10 9.5C10 8.67157 9.55228 8 9 8C8.44772 8 8 8.67157 8 9.5C8 10.3284 8.44772 11 9 11Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconGhostSmile as IconComponentType).keywords = [
  "ghost",
  "smile",
  "wraith",
  "specter",
...
export default IconGhostSmile as IconComponentType;
