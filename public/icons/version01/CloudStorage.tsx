...
(IconCloudStorage as IconComponentType).keywords = [
  "cloud",
  "storage",
  "fog",
  "mist",
...
export default IconCloudStorage as IconComponentType;
