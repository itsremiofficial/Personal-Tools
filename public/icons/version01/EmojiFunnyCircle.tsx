...
(IconEmojiFunnyCircle as IconComponentType).keywords = [
  "emoji",
  "funny",
  "circle",
  "emoticon",
...
export default IconEmojiFunnyCircle as IconComponentType;