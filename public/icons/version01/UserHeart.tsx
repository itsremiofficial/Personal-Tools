...
const IconUserHeart: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            opacity={duotone ? "0.5" : "1"}
            d="M18 17.2505C18 19.7358 18 21.7505 10 21.7505C2 21.7505 2 19.7358 2 17.2505C2 14.7652 5.58172 12.7505 10 12.7505C14.4183 12.7505 18 14.7652 18 17.2505Z"
            fill="currentColor"
          />
          <path
...
(IconUserHeart as IconComponentType).keywords = [
  "user",
  "heart",
  "exploiter",
  "enjoyer",
...
export default IconUserHeart as IconComponentType;
