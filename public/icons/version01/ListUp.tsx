  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M14 18.0002L17.5 15.0002L21 18.0002"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
