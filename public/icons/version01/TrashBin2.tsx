...
const IconTrashBin2: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconTrashBin2 as IconComponentType).keywords = [
  "trash",
  "bin",
  "2",
  "junk",
...
export default IconTrashBin2 as IconComponentType;
