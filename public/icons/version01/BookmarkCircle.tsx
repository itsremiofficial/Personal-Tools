...
(IconBookmarkCircle as IconComponentType).keywords = [
  "bookmark",
  "circle",
  "bookmarker",
  "marking",
...
export default IconBookmarkCircle as IconComponentType;
