    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M15.5303 9.03033C15.8232 8.73744 15.8232 8.26256 15.5303 7.96967C15.2374 7.67678 14.7626 7.67678 14.4697 7.96967L13.1768 9.26256C13.1067 9.33262 13.0499 9.38939 13 9.43771C12.9501 9.38939 12.8933 9.33262 12.8232 9.26256L12.213 8.65235C12.0681 8.50728 11.9113 8.35041 11.7612 8.23584C11.5852 8.10161 11.3335 7.95711 11 7.95711C10.6665 7.95711 10.4148 8.10161 10.2388 8.23584C10.0887 8.35042 9.9319 8.50732 9.78691 8.65241L8.46967 9.96967C8.17678 10.2626 8.17678 10.7374 8.46967 11.0303C8.76256 11.3232 9.23744 11.3232 9.53033 11.0303L10.8232 9.73744C10.8933 9.66738 10.9501 9.61061 11 9.56229C11.0499 9.61061 11.1067 9.66738 11.1768 9.73744L11.7869 10.3476C11.9319 10.4927 12.0887 10.6496 12.2388 10.7642C12.4148 10.8984 12.6665 11.0429 13 11.0429C13.3335 11.0429 13.5852 10.8984 13.7612 10.7642C13.9113 10.6496 14.0681 10.4927 14.2131 10.3476L15.5303 9.03033Z"
            fill="currentColor"
          />
          <path
            d="M2 1.25C1.58579 1.25 1.25 1.58579 1.25 2C1.25 2.41421 1.58579 2.75 2 2.75H4H20H22C22.4142 2.75 22.75 2.41421 22.75 2C22.75 1.58579 22.4142 1.25 22 1.25H2Z"
            fill="currentColor"
          />
          <path
            d="M11.2502 17V20.5365L9.66475 21.3292C9.29427 21.5144 9.1441 21.9649 9.32934 22.3354C9.51459 22.7059 9.96509 22.8561 10.3356 22.6708L12.0002 21.8385L13.6648 22.6708C14.0352 22.8561 14.4857 22.7059 14.671 22.3354C14.8562 21.9649 14.7061 21.5144 14.3356 21.3292L12.7502 20.5365V17H11.2502Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconPresentationGraph as IconComponentType).keywords = [
  "presentation",
  "graph",
  "demonstration",
  "intro",
...
export default IconPresentationGraph as IconComponentType;
