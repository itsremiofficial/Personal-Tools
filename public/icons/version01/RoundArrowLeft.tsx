...
(IconRoundArrowLeft as IconComponentType).keywords = [
  "round",
  "arrow",
  "left",
  "orbicular",
...
export default IconRoundArrowLeft as IconComponentType;