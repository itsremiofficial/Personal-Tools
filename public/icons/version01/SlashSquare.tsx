    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M14.0184 7.36495C14.1256 6.96486 13.8882 6.5536 13.4881 6.4464C13.088 6.33919 12.6767 6.57663 12.5695 6.97673L9.98131 16.636C9.8741 17.0361 10.1115 17.4473 10.5116 17.5545C10.9117 17.6617 11.323 17.4243 11.4302 17.0242L14.0184 7.36495Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconSlashSquare as IconComponentType).keywords = [
  "slash",
  "square",
  "flog",
  "gash",
...
export default IconSlashSquare as IconComponentType;
