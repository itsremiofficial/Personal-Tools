      ...
      {!fill ? (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M15.0004 3.25C15.4146 3.25 15.7504 3.58579 15.7504 4V5C15.7504 5.9665 14.9669 6.75 14.0004 6.75H13.0004C12.8624 6.75 12.7504 6.86193 12.7504 7V8H13.1721C15.7111 8 16.9806 8 17.9567 8.61367C18.2037 8.76898 18.433 8.95085 18.6405 9.15603C19.4602 9.96679 19.7492 11.203 20.3271 13.6753L21.3496 18.0491C21.709 19.5866 20.7536 21.1243 19.2159 21.483C17.9193 21.7856 16.5854 21.1527 15.9997 19.9569L15.8791 19.7106C15.3413 18.6127 14.2254 17.9167 13.0029 17.9167H10.998C9.77544 17.9167 8.65954 18.6127 8.12178 19.7106L8.00114 19.9569C7.41545 21.1527 6.08162 21.7856 4.78493 21.483C3.24728 21.1243 2.29188 19.5866 2.6513 18.0491L3.67373 13.6753C4.25169 11.203 4.54067 9.96679 5.36041 9.15603C5.56787 8.95085 5.79716 8.76898 6.04418 8.61367C7.02025 8 8.28977 8 10.8288 8H11.2504V7C11.2504 6.0335 12.0339 5.25 13.0004 5.25H14.0004C14.1385 5.25 14.2504 5.13807 14.2504 5V4C14.2504 3.58579 14.5862 3.25 15.0004 3.25ZM16.0004 12C16.0004 12.5523 15.5527 13 15.0004 13C14.4481 13 14.0004 12.5523 14.0004 12C14.0004 11.4477 14.4481 11 15.0004 11C15.5527 11 16.0004 11.4477 16.0004 12ZM8.50043 11.25C8.91464 11.25 9.25043 11.5858 9.25043 12V12.75H10.0004C10.4146 12.75 10.7504 13.0858 10.7504 13.5C10.7504 13.9142 10.4146 14.25 10.0004 14.25H9.25043V15C9.25043 15.4142 8.91464 15.75 8.50043 15.75C8.08621 15.75 7.75043 15.4142 7.75043 15V14.25H7.00043C6.58621 14.25 6.25043 13.9142 6.25043 13.5C6.25043 13.0858 6.58621 12.75 7.00043 12.75H7.75043V12C7.75043 11.5858 8.08621 11.25 8.50043 11.25ZM17.0004 15.5C17.5527 15.5 18.0004 15.0523 18.0004 14.5C18.0004 13.9477 17.5527 13.5 17.0004 13.5C16.4481 13.5 16.0004 13.9477 16.0004 14.5C16.0004 15.0523 16.4481 15.5 17.0004 15.5Z"
            fill="currentColor"
          />
        </svg>
      )}
...
(IconGamepadMinimalistic as IconComponentType).keywords = [
  "gamepad",
  "minimalistic",
  "joypad",
  "thumbstick",
...
export default IconGamepadMinimalistic as IconComponentType;
