...
const IconRoundTransferDiagonal: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M17.3784 19.8784L9.87842 12V16.5"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
...
(IconRoundTransferDiagonal as IconComponentType).keywords = [
  "round",
  "transfer",
  "diagonal",
  "orbicular",
...
export default IconRoundTransferDiagonal as IconComponentType;
