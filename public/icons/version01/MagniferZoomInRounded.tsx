    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M9 11.0005H11M11 11.0005H13M11 11.0005V13.0005M11 11.0005V9.00049"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M11.156 8.0249C11.5552 8.0249 11.8789 8.34855 11.8789 8.74779V10.4345H13.5656C13.9648 10.4345 14.2885 10.7582 14.2885 11.1574C14.2885 11.5567 13.9648 11.8803 13.5656 11.8803H11.8789V13.5671C11.8789 13.9663 11.5552 14.29 11.156 14.29C10.7567 14.29 10.4331 13.9663 10.4331 13.5671V11.8803H8.74633C8.34709 11.8803 8.02344 11.5567 8.02344 11.1574C8.02344 10.7582 8.34709 10.4345 8.74633 10.4345H10.4331V8.74779C10.4331 8.34855 10.7567 8.0249 11.156 8.0249Z"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M17.8194 19.7011C17.7302 18.6069 18.6357 17.6934 19.7205 17.7835C19.9086 17.7991 20.1337 17.8675 20.363 17.9372C20.3851 17.9439 20.4073 17.9507 20.4294 17.9574C20.4494 17.9634 20.4694 17.9694 20.4894 17.9754C20.7001 18.0388 20.9097 18.1018 21.0692 18.1879C21.9844 18.6823 22.2799 19.8636 21.7066 20.7367C21.6068 20.8888 21.4519 21.0446 21.2962 21.2012C21.2814 21.2161 21.2666 21.231 21.2519 21.2458C21.2371 21.2607 21.2224 21.2756 21.2076 21.2905C21.0524 21.4476 20.898 21.6039 20.7472 21.7046C19.8816 22.2828 18.7105 21.9848 18.2204 21.0615C18.135 20.9007 18.0725 20.6893 18.0097 20.4767C18.0038 20.4565 17.9978 20.4364 17.9918 20.4162C17.9852 20.3939 17.9785 20.3715 17.9719 20.3493C17.9028 20.1179 17.8349 19.8908 17.8194 19.7011Z"
            fill="currentColor"
          />
          <path
            d="M11.1566 20.3137C16.2137 20.3137 20.3133 16.2142 20.3133 11.1571C20.3133 6.10005 16.2137 2.00049 11.1566 2.00049C6.09956 2.00049 2 6.10005 2 11.1571C2 16.2142 6.09956 20.3137 11.1566 20.3137Z"
...
(IconMagniferZoomInRounded as IconComponentType).keywords = [
  "magnifer",
  "zoom",
  "in",
  "rounded",
...
export default IconMagniferZoomInRounded as IconComponentType;
