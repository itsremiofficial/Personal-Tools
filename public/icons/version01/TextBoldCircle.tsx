  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M8.75 11.2505H12C13.2426 11.2505 14.25 10.2431 14.25 9.00049C14.25 7.75785 13.2426 6.75049 12 6.75049H9.52174C9.09552 6.75049 8.75 7.09601 8.75 7.52223V11.2505Z"
            fill="currentColor"
          />
          <path
            d="M8.75 12.7505V16.824C8.75 17.0596 8.94094 17.2505 9.17647 17.2505H13C14.2426 17.2505 15.25 16.2431 15.25 15.0005C15.25 13.7578 14.2426 12.7505 13 12.7505H8.75Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
...
(IconTextBoldCircle as IconComponentType).keywords = [
  "text",
  "bold",
  "circle",
  "schoolbook",
...
export default IconTextBoldCircle as IconComponentType;
