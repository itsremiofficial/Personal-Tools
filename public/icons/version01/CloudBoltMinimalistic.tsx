...
(IconCloudBoltMinimalistic as IconComponentType).keywords = [
  "cloud",
  "bolt",
  "minimalistic",
  "fog",
...
export default IconCloudBoltMinimalistic as IconComponentType;
