  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M16.54 2.08783C15.3292 2 13.8452 2 11.9999 2H11.9014L8.40133 7.25002H13.0986L16.54 2.08783Z"
            fill="currentColor"
          />
          <path
          ...
          />
          <path
            d="M20.5355 3.46447C21.3931 4.32213 21.7485 5.48593 21.8958 7.25002H14.9013L18.1987 2.30403C19.1923 2.51345 19.9382 2.86714 20.5355 3.46447Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.5" : "1"}
