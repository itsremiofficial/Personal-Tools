...
const IconSquareArrowLeftDown: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconSquareArrowLeftDown as IconComponent).keywords = [
  "square",
  "arrow",
  "left",
  "down",
...
export default IconSquareArrowLeftDown as IconComponent;
