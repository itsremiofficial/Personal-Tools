...
const IconDropperMinimalistic2: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M14 10.9168C14 12.0674 13.1046 13.0001 12 13.0001C10.8954 13.0001 10 12.0674 10 10.9168C10 10.1969 10.783 9.23601 11.3691 8.61755C11.7161 8.25143 12.2839 8.25143 12.6309 8.61755C13.217 9.23601 14 10.1969 14 10.9168Z"
            stroke="currentColor"
            strokeWidth={width}
          />
          <path
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M9.25 16.0002C9.25 15.586 9.58579 15.2502 10 15.2502H14C14.4142 15.2502 14.75 15.586 14.75 16.0002C14.75 16.4145 14.4142 16.7502 14 16.7502H10C9.58579 16.7502 9.25 16.4145 9.25 16.0002Z"
            fill="currentColor"
          />
          <path
            d="M14 10.9168C14 12.0674 13.1046 13.0002 12 13.0002C10.8954 13.0002 10 12.0674 10 10.9168C10 10.1969 10.783 9.23607 11.3691 8.61761C11.7161 8.25149 12.2839 8.25149 12.6309 8.61761C13.217 9.23607 14 10.1969 14 10.9168Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconDropperMinimalistic2 as IconComponentType).keywords = [
  "dropper",
  "minimalistic",
  "2",
  "eye dropper",
...
export default IconDropperMinimalistic2 as IconComponentType;
