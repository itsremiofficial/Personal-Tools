...
(IconHashtagSquare as IconComponentType).keywords = [
  "hashtag",
  "square",
  "slashtag",
  "bashtag",
...
export default IconHashtagSquare as IconComponentType;
