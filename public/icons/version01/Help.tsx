    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M5.47912 19.5816L9.75186 15.3089C9.33517 15.0253 8.97484 14.665 8.69116 14.2483L4.41844 18.521C4.74507 18.9004 5.0997 19.255 5.47912 19.5816Z"
            fill="currentColor"
          />
          <path
            d="M4.41833 5.479L8.69106 9.75172C8.97473 9.33504 9.33504 8.97473 9.75172 8.69106L5.479 4.41833C5.09959 4.74496 4.74496 5.09959 4.41833 5.479Z"
            fill="currentColor"
          />
          <path
            d="M14.2483 8.69116L18.521 4.41844C18.9004 4.74507 19.255 5.0997 19.5816 5.47912L15.3089 9.75186C15.0253 9.33517 14.665 8.97484 14.2483 8.69116Z"
            fill="currentColor"
          />
          <path
            d="M19.5815 18.5209L15.3088 14.2482C15.0252 14.6648 14.6648 15.0252 14.2482 15.3088L18.5209 19.5815C18.9003 19.2549 19.2549 18.9003 19.5815 18.5209Z"
            fill="currentColor"
          />
        </svg>
      ) : (
