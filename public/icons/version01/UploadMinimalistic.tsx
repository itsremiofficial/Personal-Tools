...
const IconUploadMinimalistic: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconUploadMinimalistic as IconComponentType).keywords = [
  "upload",
  "minimalistic",
  "download",
  "loader",
...
export default IconUploadMinimalistic as IconComponentType;
