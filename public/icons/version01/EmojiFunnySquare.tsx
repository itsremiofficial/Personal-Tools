...
(IconEmojiFunnySquare as IconComponentType).keywords = [
  "emoji",
  "funny",
  "square",
  "emoticon",
...
export default IconEmojiFunnySquare as IconComponentType;
