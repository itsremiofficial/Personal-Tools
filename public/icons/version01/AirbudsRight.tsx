...
const IconAirbudsRight: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            opacity={duotone ? "0.5" : "1"}
            d="M9 5.1001C7.04087 5.49778 5.4977 7.04095 5.10002 9.00008"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
        ...
        >
          ...
          <g opacity={duotone ? "0.5" : "1"}>
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M10.7347 4.95056C10.8171 5.35649 10.5549 5.75237 10.1489 5.83477C8.485 6.17253 7.17253 7.485 6.83477 9.14894C6.75237 9.55487 6.35649 9.81715 5.95056 9.73475C5.54462 9.65235 5.28235 9.25647 5.36475 8.85054C5.82235 6.59622 7.59622 4.82235 9.85054 4.36475C10.2565 4.28235 10.6523 4.54462 10.7347 4.95056Z"
              fill="currentColor"
            />
          </g>
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M6 13.25C5.58579 13.25 5.25 13.5858 5.25 14V19C5.25 19.4142 5.58579 19.75 6 19.75C6.41421 19.75 6.75 19.4142 6.75 19V17.25H7.07536L8.35688 19.3859C8.56999 19.7411 9.03069 19.8562 9.38587 19.6431C9.74106 19.43 9.85623 18.9693 9.64312 18.6141L8.65373 16.9651C9.28176 16.6355 9.75 16.0358 9.75 15.25C9.75 14.0232 8.6088 13.25 7.5 13.25H6ZM6.75 14.75V15.75H7.5C8.04806 15.75 8.25 15.4039 8.25 15.25C8.25 15.0961 8.04806 14.75 7.5 14.75H6.75Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconAirbudsRight as IconComponent).keywords = [
  "airbuds",
  "right",
  "straight",
  "precise",
...
export default IconAirbudsRight as IconComponent;
