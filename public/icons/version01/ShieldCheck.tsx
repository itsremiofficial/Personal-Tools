...
const IconShieldCheck: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M9.5 12.4005L10.9286 14.0005L14.5 10.0005"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M15.0595 10.5C15.3353 10.191 15.3085 9.71692 14.9995 9.44104C14.6905 9.16517 14.2164 9.19201 13.9406 9.50098L10.9286 12.8744L10.0595 11.901C9.78359 11.592 9.30947 11.5652 9.0005 11.841C8.69152 12.1169 8.66468 12.591 8.94055 12.9L10.3691 14.5C10.5114 14.6594 10.7149 14.7505 10.9286 14.7505C11.1422 14.7505 11.3457 14.6594 11.488 14.5L15.0595 10.5Z"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M3.37752 5.0829C3 5.62077 3 7.21956 3 10.4171V11.9918C3 17.6299 7.23896 20.366 9.89856 21.5278C10.62 21.8429 10.9807 22.0005 12 22.0005C13.0193 22.0005 13.38 21.8429 14.1014 21.5278C16.761 20.366 21 17.6299 21 11.9918V10.4171C21 7.21956 21 5.62077 20.6225 5.0829C20.245 4.54503 18.7417 4.03045 15.7351 3.00128L15.1623 2.80521C13.595 2.26873 12.8114 2.00049 12 2.00049C11.1886 2.00049 10.405 2.26873 8.83772 2.8052L8.26491 3.00128C5.25832 4.03045 3.75503 4.54503 3.37752 5.0829ZM15.0595 10.5C15.3353 10.191 15.3085 9.71691 14.9995 9.44104C14.6905 9.16516 14.2164 9.192 13.9405 9.50098L10.9286 12.8744L10.0595 11.901C9.78358 11.592 9.30947 11.5652 9.00049 11.841C8.69151 12.1169 8.66467 12.591 8.94055 12.9L10.3691 14.5C10.5114 14.6594 10.7149 14.7505 10.9286 14.7505C11.1422 14.7505 11.3457 14.6594 11.488 14.5L15.0595 10.5Z"
            fill="currentColor"
          />
        </svg>
      )}
...
(IconShieldCheck as IconComponentType).keywords = [
  "shield",
  "check",
  "buckler",
  "screen",
...
export default IconShieldCheck as IconComponentType;
