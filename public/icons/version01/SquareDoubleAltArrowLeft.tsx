...
const IconSquareDoubleAltArrowLeft: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconSquareDoubleAltArrowLeft as IconComponentType).keywords = [
  "square",
  "double",
  "alt",
  "arrow",
...
export default IconSquareDoubleAltArrowLeft as IconComponentType;
