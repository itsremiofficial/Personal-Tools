...
(IconMagnifierBugMinimalistic as IconComponentType).keywords = [
  "magnifier",
  "bug",
  "minimalistic",
  "expander",
...
export default IconMagnifierBugMinimalistic as IconComponentType;
