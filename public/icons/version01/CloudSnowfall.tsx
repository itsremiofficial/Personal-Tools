      ...
      {!fill ? (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M12.001 14.25C12.4152 14.25 12.751 14.5858 12.751 15V17.1633L14.6241 16.0819C14.9828 15.8748 15.4415 15.9977 15.6486 16.3564C15.8557 16.7152 15.7328 17.1739 15.3741 17.381L13.501 18.4624L15.3767 19.5453C15.7354 19.7524 15.8583 20.2111 15.6512 20.5698C15.4441 20.9285 14.9854 21.0514 14.6267 20.8443L12.751 19.7614V22C12.751 22.4142 12.4152 22.75 12.001 22.75C11.5868 22.75 11.251 22.4142 11.251 22V19.7614L9.37537 20.8443C9.01665 21.0514 8.55796 20.9285 8.35085 20.5698C8.14374 20.2111 8.26665 19.7524 8.62537 19.5453L10.501 18.4624L8.62799 17.381C8.26927 17.1739 8.14636 16.7152 8.35347 16.3564C8.56058 15.9977 9.01927 15.8748 9.37799 16.0819L11.251 17.1633V15C11.251 14.5858 11.5868 14.25 12.001 14.25Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.5" : "1"}
...
(IconCloudSnowfall as IconComponentType).keywords = [
  "cloud",
  "snowfall",
  "fog",
  "mist",
...
export default IconCloudSnowfall as IconComponentType;
