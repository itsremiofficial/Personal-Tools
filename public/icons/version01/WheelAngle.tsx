  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M16.5 22.0005C18.9853 22.0005 21 17.5233 21 12.0005C21 6.47764 18.9853 2.00049 16.5 2.00049"
            stroke="currentColor"
            strokeWidth={width}
          />
          <path
            d="M12 12.0005C12 17.5233 9.98528 22.0005 7.5 22.0005C5.01472 22.0005 3 17.5233 3 12.0005C3 6.47764 5.01472 2.00049 7.5 2.00049C9.98528 2.00049 12 6.47764 12 12.0005Z"
            stroke="currentColor"
            strokeWidth={width}
          />
          <path
            d="M7.5 2.00049L16.5 2.00049"
            stroke="currentColor"
            strokeWidth={width}
          />
          <path
            d="M7.5 22.0005L16.5 22.0005"
            stroke="currentColor"
            strokeWidth={width}
          />
          <path
            opacity={duotone ? "0.5" : "1"}
            d="M9 12.0005C9 15.3142 8.32843 18.0005 7.5 18.0005C6.67157 18.0005 6 15.3142 6 12.0005C6 8.68678 6.67157 6.00049 7.5 6.00049C8.32843 6.00049 9 8.68678 9 12.0005ZM9 12.0005H8"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          />
