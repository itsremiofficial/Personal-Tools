      ...
      {!fill ? (
        ...
        >
          ...
          <path
            ...
            d="M3.66992 11C3.66992 11.84 4.29992 12.81 5.06992 13.15L11.8599 16.17C12.3799 16.4 12.9699 16.4 13.4799 16.17L20.2699 13.15C21.0399 12.81 21.6699 11.84 21.6699 11"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M3.66992 16C3.66992 16.93 4.21992 17.77 5.06992 18.15L11.8599 21.17C12.3799 21.4 12.9699 21.4 13.4799 21.17L20.2699 18.15C21.1199 17.77 21.6699 16.93 21.6699 16"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        >
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M12.6702 17.04C12.2902 17.04 11.9102 16.96 11.5602 16.81L4.82023 13.81C3.79023 13.35 2.99023 12.12 2.99023 10.99C2.99023 10.58 3.32023 10.25 3.73023 10.25C4.14023 10.25 4.47023 10.58 4.47023 10.99C4.47023 11.53 4.92023 12.23 5.42023 12.45L12.1602 15.45C12.4802 15.59 12.8502 15.59 13.1702 15.45L19.9102 12.45C20.4102 12.23 20.8602 11.54 20.8602 10.99C20.8602 10.58 21.1902 10.25 21.6002 10.25C22.0102 10.25 22.3402 10.58 22.3402 10.99C22.3402 12.11 21.5402 13.35 20.5102 13.81L13.7702 16.81C13.4302 16.96 13.0502 17.04 12.6702 17.04Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M12.6702 22C12.2902 22 11.9102 21.92 11.5602 21.77L4.82023 18.77C3.71023 18.28 2.99023 17.17 2.99023 15.95C2.99023 15.54 3.32023 15.21 3.73023 15.21C4.14023 15.21 4.47023 15.54 4.47023 15.95C4.47023 16.58 4.84023 17.15 5.42023 17.41L12.1602 20.41C12.4802 20.55 12.8502 20.55 13.1702 20.41L19.9102 17.41C20.4802 17.16 20.8602 16.58 20.8602 15.95C20.8602 15.54 21.1902 15.21 21.6002 15.21C22.0102 15.21 22.3402 15.54 22.3402 15.95C22.3402 17.17 21.6202 18.27 20.5102 18.77L13.7702 21.77C13.4302 21.92 13.0502 22 12.6702 22Z"
            fill="currentColor"
          />
        </svg>
      ) : (
