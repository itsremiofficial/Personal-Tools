...
const IconArrowSquareLeft: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M16.8599 2H8.47992C4.83992 2 2.66992 4.17 2.66992 7.81V16.18C2.66992 19.83 4.83992 22 8.47992 22H16.8499C20.4899 22 22.6599 19.83 22.6599 16.19V7.81C22.6699 4.17 20.4999 2 16.8599 2ZM14.4599 15C14.7499 15.29 14.7499 15.77 14.4599 16.06C14.3099 16.21 14.1199 16.28 13.9299 16.28C13.7399 16.28 13.5499 16.21 13.3999 16.06L9.86992 12.53C9.57992 12.24 9.57992 11.76 9.86992 11.47L13.3999 7.94C13.6899 7.65 14.1699 7.65 14.4599 7.94C14.7499 8.23 14.7499 8.71 14.4599 9L11.4599 12L14.4599 15Z"
            fill="currentColor"
          />
        </svg>
      )}
...
(IconArrowSquareLeft as IconComponentType).keywords = [
  "arrow",
  "square",
  "left",
  "pointer",
...
export default IconArrowSquareLeft as IconComponentType;
