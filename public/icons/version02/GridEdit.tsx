    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            d="M19.3998 14.6701L15.2499 18.82C15.0899 18.98 14.9398 19.29 14.8998 19.51L14.6699 21.1C14.5899 21.67 14.9899 22.08 15.5599 21.99L17.1498 21.76C17.3698 21.73 17.6798 21.5701 17.8398 21.4101L21.9899 17.26C22.6999 16.55 23.0399 15.7101 21.9899 14.6601C20.9499 13.6201 20.1198 13.9501 19.3998 14.6701Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
          ...
          />
          <path
            d="M18.8101 15.26C19.1601 16.52 20.15 17.5 21.41 17.86"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          <path
            d="M21.9999 14.67C20.9499 13.62 20.1198 13.96 19.3998 14.67L15.2499 18.82C15.0899 18.98 14.9398 19.29 14.8998 19.51L14.6699 21.0999C14.5899 21.6699 14.9899 22.08 15.5599 21.99L17.1498 21.76C17.3698 21.73 17.6798 21.5699 17.8398 21.4099L21.9899 17.26C22.7199 16.55 23.0499 15.72 21.9999 14.67Z"
            fill="currentColor"
          />
          <path
          ...
          />
          <path
            d="M22.4402 7.92993C22.4402 8.30993 22.1303 8.60992 21.7603 8.60992H16.0103V2.15991H16.6802C19.8602 2.16991 22.4402 4.74993 22.4402 7.92993Z"
            fill="currentColor"
          />
          <path
            d="M9.06036 15.5498V21.3098C9.06036 21.6898 8.75037 21.9898 8.38037 21.9898H8.37036C5.19036 21.9898 2.61035 19.4098 2.61035 16.2298V15.5498H9.06036Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M9.07037 8.60986H2.61035V15.5499H9.07037V8.60986Z"
            fill="currentColor"
          />
          <path
            d="M16.0001 8.60986V14.5499C16.0001 15.0999 15.5501 15.5499 15.0001 15.5499H9.06006V8.60986H16.0001Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M16.0001 2.16992H9.06006V8.61993H16.0001V2.16992Z"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          <path
            d="M21.9999 14.67C20.9499 13.62 20.1199 13.96 19.3999 14.67L15.2499 18.82C15.0899 18.98 14.9399 19.29 14.8999 19.51L14.6699 21.1C14.5899 21.67 14.9899 22.08 15.5599 21.99L17.1499 21.76C17.3699 21.73 17.6799 21.57 17.8399 21.41L21.9899 17.26C22.7199 16.55 23.0499 15.72 21.9999 14.67Z"
            fill="currentColor"
          />
          <path
...
(IconGridEdit as IconComponentType).keywords = [
  "grid",
  "edit",
  "gridiron",
  "control grid",
...
export default IconGridEdit as IconComponentType;
