...
const IconSidebarRight: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M8.63989 9.43994L11.1999 11.9999L8.63989 14.5599"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
...
(IconSidebarRight as IconComponentType).keywords = [
  "sidebar",
  "right",
  "billet",
  "margin",
...
export default IconSidebarRight as IconComponentType;
