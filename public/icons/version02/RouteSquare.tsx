...
const IconRouteSquare: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          <path
            ...
            d="M18.0199 9.04979L15.6799 16.5898C15.1199 18.3798 12.6099 18.4098 12.0199 16.6298L11.3199 14.5598C11.1299 13.9898 10.6799 13.5298 10.1099 13.3498L8.0299 12.6498C6.2599 12.0598 6.28989 9.5298 8.07989 8.9898L15.6199 6.63979C17.0999 6.18979 18.4899 7.57979 18.0199 9.04979Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M18.0199 9.04979L15.6799 16.5898C15.1199 18.3798 12.6099 18.4098 12.0199 16.6298L11.3199 14.5598C11.1299 13.9898 10.6799 13.5298 10.1099 13.3498L8.0299 12.6498C6.2599 12.0598 6.28989 9.52979 8.07989 8.98979L15.6199 6.63979C17.0999 6.18979 18.4899 7.57979 18.0199 9.04979Z"
            fill="currentColor"
          />
        </svg>
      ) : (
