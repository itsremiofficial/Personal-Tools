    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M16.3298 13.47L15.5898 12.73C15.9698 12.15 16.1998 11.45 16.1998 10.7C16.1998 8.66001 14.5398 7 12.4998 7C10.4598 7 8.7998 8.66001 8.7998 10.7C8.7998 12.74 10.4598 14.4 12.4998 14.4C13.2498 14.4 13.9498 14.17 14.5298 13.79L15.2698 14.53C15.4198 14.68 15.6098 14.75 15.7998 14.75C15.9898 14.75 16.1798 14.68 16.3298 14.53C16.6198 14.24 16.6198 13.76 16.3298 13.47Z"
            fill="currentColor"
          />
        </svg>
      ) : (
