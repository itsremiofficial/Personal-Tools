      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            ...
            />
            <path
              d="M15.1719 8.93994C15.1719 13.2399 11.8119 16.7199 7.67188 16.7199"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M17.6721 16.72C15.8721 16.72 14.2721 15.76 13.1221 14.25"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          <path
            d="M16.8619 2H8.48187C4.84187 2 2.67188 4.17 2.67188 7.81V16.18C2.67188 19.83 4.84187 22 8.48187 22H16.8519C20.4919 22 22.6619 19.83 22.6619 16.19V7.81C22.6719 4.17 20.5019 2 16.8619 2ZM17.6719 17.47C15.9619 17.47 14.3619 16.73 13.0819 15.36C11.6319 16.67 9.74187 17.47 7.67188 17.47C7.26188 17.47 6.92188 17.13 6.92188 16.72C6.92188 16.31 7.26188 15.97 7.67188 15.97C11.1419 15.97 14.0119 13.22 14.3819 9.7H12.6719H7.68188C7.27188 9.7 6.93188 9.36 6.93188 8.95C6.93188 8.54 7.27188 8.21 7.68188 8.21H11.9219V7.28C11.9219 6.87 12.2619 6.53 12.6719 6.53C13.0819 6.53 13.4219 6.87 13.4219 7.28V8.21H15.1119C15.1319 8.21 15.1519 8.2 15.1719 8.2C15.1919 8.2 15.2119 8.21 15.2319 8.21H17.6619C18.0719 8.21 18.4119 8.55 18.4119 8.96C18.4119 9.37 18.0719 9.71 17.6619 9.71H15.8819C15.7319 11.42 15.0919 12.99 14.1119 14.27C15.1119 15.38 16.3619 15.98 17.6719 15.98C18.0819 15.98 18.4219 16.32 18.4219 16.73C18.4219 17.14 18.0819 17.47 17.6719 17.47Z"
            fill="currentColor"
          />
        </svg>
      )}
