  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M19.7396 4.95002C23.7096 8.92002 23.6396 15.4 19.5396 19.29C15.7496 22.88 9.59964 22.88 5.79964 19.29C1.68964 15.4 1.61963 8.92002 5.59963 4.95002C9.49963 1.04002 15.8396 1.04002 19.7396 4.95002Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          ...
          <path
            ...
            d="M16.5098 16.07C14.3898 18.07 10.9498 18.07 8.83984 16.07"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
...
(IconGrammerly as IconComponentType).keywords = ["grammerly"];
