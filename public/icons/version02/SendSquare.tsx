      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M9.66992 9.51001L12.6699 6.51001L15.6699 9.51001"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M12.1396 5.97968C12.4325 5.68679 12.9074 5.68679 13.2003 5.97968L16.2003 8.97968C16.4931 9.27257 16.4931 9.74745 16.2003 10.0403C15.9074 10.3332 15.4325 10.3332 15.1396 10.0403L12.6699 7.57067L10.2003 10.0403C9.90736 10.3332 9.43248 10.3332 9.13959 10.0403C8.8467 9.74745 8.8467 9.27257 9.13959 8.97968L12.1396 5.97968Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M12.6699 5.76001C13.0841 5.76001 13.4199 6.0958 13.4199 6.51001V14.51C13.4199 14.9242 13.0841 15.26 12.6699 15.26C12.2557 15.26 11.9199 14.9242 11.9199 14.51V6.51001C11.9199 6.0958 12.2557 5.76001 12.6699 5.76001Z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M5.9588 16.2722C6.09008 15.8794 6.51499 15.6674 6.90784 15.7986C10.6436 17.0471 14.6967 17.0471 18.4324 15.7986C18.8253 15.6674 19.2502 15.8794 19.3815 16.2722C19.5127 16.6651 19.3007 17.09 18.9078 17.2213C14.8636 18.5729 10.4767 18.5729 6.43241 17.2213C6.03955 17.09 5.82751 16.6651 5.9588 16.2722Z"
            fill="currentColor"
          />
        </svg>
      ) : (
