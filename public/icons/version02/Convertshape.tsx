...
const IconConvertshape: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M22.6699 5.15V8.85C22.6699 11.1 21.7699 12 19.5199 12H16.8199C14.5699 12 13.6699 11.1 13.6699 8.85V5.15C13.6699 2.9 14.5699 2 16.8199 2H19.5199C21.7699 2 22.6699 2.9 22.6699 5.15Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          ...
          />
          <path
            d="M11.6699 15.15V18.85C11.6699 21.1 10.7699 22 8.51992 22H5.81992C3.56992 22 2.66992 21.1 2.66992 18.85V15.15C2.66992 12.9 3.56992 12 5.81992 12H8.51992C10.7699 12 11.6699 12.9 11.6699 15.15Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
            strokeLinejoin="round"
...
(IconConvertshape as IconComponentType).keywords = ["convertshape"];
