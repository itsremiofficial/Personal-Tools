...
const IconMaximize4: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
...
(IconMaximize4 as IconComponentType).keywords = [
  "maximize",
  "4",
  "max",
  "maximum",
...
export default IconMaximize4 as IconComponentType;
