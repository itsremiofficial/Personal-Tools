      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M12.6699 11.5C13.7745 11.5 14.6699 10.6046 14.6699 9.5C14.6699 8.39543 13.7745 7.5 12.6699 7.5C11.5654 7.5 10.6699 8.39543 10.6699 9.5C10.6699 10.6046 11.5654 11.5 12.6699 11.5Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
            />
            <path
              d="M10.6699 13.5C11.9199 14.13 13.3999 14.13 14.6599 13.51L14.6699 13.5"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
            ...
            />
            <path
              d="M10.6699 16.5L12.6699 13.97L14.6699 16.5"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M12.67 11.88C13.9845 11.88 15.05 10.8144 15.05 9.5C15.05 8.18556 13.9845 7.12 12.67 7.12C11.3556 7.12 10.29 8.18556 10.29 9.5C10.29 10.8144 11.3556 11.88 12.67 11.88Z"
            fill="currentColor"
          />
          <path
            d="M15.2597 16.03L14.0597 14.52C14.3897 14.43 14.7197 14.31 15.0297 14.16C15.3897 13.96 15.5197 13.52 15.3297 13.16C15.1397 12.8 14.6897 12.66 14.3297 12.84C13.2897 13.36 12.0497 13.36 11.0097 12.84C10.6397 12.65 10.1897 12.8 9.99972 13.17C9.80972 13.54 9.95968 13.99 10.3297 14.18C10.6297 14.33 10.9497 14.45 11.2697 14.53L10.0797 16.04C9.81968 16.37 9.87974 16.84 10.1997 17.09C10.5297 17.35 10.9997 17.29 11.2497 16.97L12.6597 15.19L14.0697 16.97C14.2197 17.16 14.4397 17.25 14.6597 17.25C14.8197 17.25 14.9897 17.2 15.1197 17.09C15.4597 16.83 15.5097 16.36 15.2597 16.03Z"
            fill="currentColor"
          />
        </svg>
      ) : (
