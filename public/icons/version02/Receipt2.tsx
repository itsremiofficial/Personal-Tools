...
const IconReceipt2: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M16.9004 11.75H11.4004C10.9904 11.75 10.6504 11.41 10.6504 11C10.6504 10.59 10.9904 10.25 11.4004 10.25H16.9004C17.3104 10.25 17.6504 10.59 17.6504 11C17.6504 11.41 17.3104 11.75 16.9004 11.75Z"
            fill="currentColor"
          />
          <path
            d="M16.9004 7.75H11.4004C10.9904 7.75 10.6504 7.41 10.6504 7C10.6504 6.59 10.9904 6.25 11.4004 6.25H16.9004C17.3104 6.25 17.6504 6.59 17.6504 7C17.6504 7.41 17.3104 7.75 16.9004 7.75Z"
            fill="currentColor"
          />
          <path
            d="M8.4502 8C7.9002 8 7.4502 7.55 7.4502 7C7.4502 6.45 7.9002 6 8.4502 6C9.0002 6 9.45019 6.45 9.45019 7C9.45019 7.55 9.0002 8 8.4502 8Z"
            fill="currentColor"
          />
          <path
            d="M8.4502 12C7.9002 12 7.4502 11.55 7.4502 11C7.4502 10.45 7.9002 10 8.4502 10C9.0002 10 9.45019 10.45 9.45019 11C9.45019 11.55 9.0002 12 8.4502 12Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconReceipt2 as IconComponentType).keywords = [
  "receipt",
  "2",
  "receiving",
  "reception",
...
export default IconReceipt2 as IconComponentType;
