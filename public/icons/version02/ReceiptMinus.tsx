    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M12.4199 10.75H6.91992C6.50992 10.75 6.16992 10.41 6.16992 10C6.16992 9.59 6.50992 9.25 6.91992 9.25H12.4199C12.8299 9.25 13.1699 9.59 13.1699 10C13.1699 10.41 12.8299 10.75 12.4199 10.75Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconReceiptMinus as IconComponentType).keywords = [
  "receipt",
  "minus",
  "receiving",
  "reception",
...
export default IconReceiptMinus as IconComponentType;
