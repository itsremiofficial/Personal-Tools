...
const IconBackSquare: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M9.66982 15.38H14.5898C16.2898 15.38 17.6698 14 17.6698 12.3C17.6698 10.6 16.2898 9.21997 14.5898 9.21997H7.81982"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
            ...
            />
            <path
              d="M9.23992 10.77L7.66992 9.18999L9.23992 7.62"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
...
(IconBackSquare as IconComponent).keywords = [
  "back",
  "square",
  "backward",
  "rearward",
...
export default IconBackSquare as IconComponent;
