  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M22.6699 9V15C22.6699 15.22 22.6699 15.44 22.6499 15.65C21.8299 14.64 20.5799 14 19.1699 14C18.1099 14 17.1299 14.37 16.3599 14.99C15.3199 15.81 14.6699 17.08 14.6699 18.5C14.6699 19.91 15.3099 21.16 16.3199 21.98C16.1099 22 15.8899 22 15.6699 22H9.66992C4.66992 22 2.66992 20 2.66992 15V9C2.66992 4 4.66992 2 9.66992 2H15.6699C20.6699 2 22.6699 4 22.6699 9Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeLinecap="round"
          ...
          <path
            d="M23.6699 18.5C23.6699 19.85 23.0699 21.05 22.1399 21.88C21.3399 22.57 20.3099 23 19.1699 23C18.0899 23 17.0899 22.62 16.3199 21.98C15.3099 21.16 14.6699 19.91 14.6699 18.5C14.6699 17.08 15.3199 15.81 16.3599 14.99C17.1299 14.37 18.1099 14 19.1699 14C20.5799 14 21.8299 14.64 22.6499 15.65C23.2899 16.42 23.6699 17.42 23.6699 18.5Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
          ...
          <path
            ...
            d="M19.4498 17.09V18.78L18.0498 19.62"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          <path
            d="M22.6499 15.65C21.8299 14.64 20.5799 14 19.1699 14C18.1099 14 17.1299 14.37 16.3599 14.99C15.3199 15.81 14.6699 17.08 14.6699 18.5C14.6699 19.91 15.3099 21.16 16.3199 21.98C17.0899 22.62 18.0899 23 19.1699 23C20.3099 23 21.3399 22.57 22.1399 21.88C23.0699 21.05 23.6699 19.85 23.6699 18.5C23.6699 17.42 23.2899 16.42 22.6499 15.65ZM20.1999 18.78C20.1999 19.04 20.0599 19.29 19.8399 19.42L18.4299 20.26C18.3099 20.33 18.1799 20.37 18.0399 20.37C17.7899 20.37 17.5399 20.24 17.3999 20.01C17.1899 19.65 17.2999 19.19 17.6599 18.98L18.6999 18.36V17.1C18.6999 16.69 19.0399 16.35 19.4499 16.35C19.8599 16.35 20.1999 16.69 20.1999 17.1V18.78Z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M22.6699 7.81V15.7C22.6699 15.69 22.6599 15.68 22.6499 15.67C22.6099 15.61 22.5599 15.55 22.5099 15.5C22.4999 15.49 22.4899 15.47 22.4799 15.46C21.6699 14.56 20.4799 14 19.1699 14C17.9099 14 16.7599 14.52 15.9399 15.36C15.1499 16.17 14.6699 17.28 14.6699 18.5C14.6699 19.34 14.9099 20.14 15.3199 20.82C15.5399 21.19 15.8199 21.53 16.1399 21.81C16.1599 21.82 16.1699 21.83 16.1799 21.84C16.2299 21.89 16.2799 21.93 16.3399 21.98C16.3399 21.98 16.3399 21.98 16.3499 21.98C16.3599 21.99 16.3699 22 16.3799 22H8.47992C4.83992 22 2.66992 19.83 2.66992 16.19V7.81C2.66992 7.3 2.70993 6.80999 2.79993 6.35999C3.30993 3.60999 5.33991 2.01 8.43991 2H16.8999C19.9999 2.01 22.0299 3.60999 22.5399 6.35999C22.6299 6.80999 22.6699 7.3 22.6699 7.81Z"
            fill="currentColor"
          />
          <path
            d="M22.6699 7.81V7.85999H2.66992V7.81C2.66992 7.3 2.70993 6.80999 2.79993 6.35999H8.43991V2H9.93991V6.35999H15.3999V2H16.8999V6.35999H22.5399C22.6299 6.80999 22.6699 7.3 22.6699 7.81Z"
            fill="currentColor"
          />
        </svg>
      ) : (
