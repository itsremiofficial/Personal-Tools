      ...
      {!fill ? (
        ...
        >
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M9.60924 16.9301L6.77922 14.1C5.83922 13.16 5.83922 12.2101 6.77922 11.2701L11.4992 6.55005L16.6892 11.7401C16.9492 12.0001 16.9492 12.4201 16.6892 12.6801L12.4392 16.9301C11.4992 17.8701 10.5492 17.8701 9.60924 16.9301Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
            ...
            />
            <path
              d="M10.5488 5.6001L11.4988 6.5401"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
            ...
            />
            <path
              d="M6.10938 12.6401L16.7994 12.1702"
              stroke="currentColor"
              strokeWidth={width}
              strokeMiterlimit="10"
              strokeLinecap="round"
            ...
            />
            <path
              d="M17.9702 14.8101C17.9702 14.8101 16.6602 16.23 16.6602 17.1C16.6602 17.82 17.2502 18.41 17.9702 18.41C18.6902 18.41 19.2802 17.82 19.2802 17.1C19.2702 16.23 17.9702 14.8101 17.9702 14.8101Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
