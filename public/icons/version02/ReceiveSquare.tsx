      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M9.66992 11.51L12.6699 14.51L15.6699 11.51"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M12.1404 15.04C12.2104 15.11 12.2903 15.16 12.3803 15.2C12.4703 15.24 12.5704 15.26 12.6704 15.26C12.7704 15.26 12.8604 15.24 12.9604 15.2C13.0504 15.16 13.1303 15.11 13.2003 15.04L16.2003 12.04C16.4903 11.75 16.4903 11.27 16.2003 10.98C15.9103 10.69 15.4304 10.69 15.1404 10.98L13.4204 12.7V6.51001C13.4204 6.10001 13.0804 5.76001 12.6704 5.76001C12.2604 5.76001 11.9204 6.10001 11.9204 6.51001V12.7L10.2003 10.98C9.91035 10.69 9.43035 10.69 9.14035 10.98C8.85035 11.27 8.85035 11.75 9.14035 12.04L12.1404 15.04Z"
            fill="currentColor"
          />
          <path
            d="M19.3801 16.28C19.2501 15.89 18.8301 15.68 18.4301 15.81C14.7101 17.05 10.6201 17.05 6.90011 15.81C6.51011 15.68 6.0801 15.89 5.9501 16.28C5.8201 16.67 6.0301 17.1 6.4201 17.23C8.4301 17.9 10.5401 18.24 12.6601 18.24C14.7801 18.24 16.8901 17.9 18.9001 17.23C19.3001 17.09 19.5101 16.67 19.3801 16.28Z"
            fill="currentColor"
          />
        </svg>
      ) : (
