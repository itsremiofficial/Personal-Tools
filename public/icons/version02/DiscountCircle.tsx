...
const IconDiscountCircle: FC<IconProps> = ({
  className,
  fill = false,
  duotone = true,
  width = "1.5",
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M9.6694 15.75C9.4794 15.75 9.28938 15.68 9.13938 15.53C8.84938 15.24 8.84938 14.7599 9.13938 14.4699L15.1394 8.46994C15.4294 8.17994 15.9094 8.17994 16.1994 8.46994C16.4894 8.75994 16.4894 9.24 16.1994 9.53L10.1994 15.53C10.0494 15.68 9.8594 15.75 9.6694 15.75Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
(IconDiscountCircle as IconComponentType).keywords = [
  "discount",
  "circle",
  "bank discount",
  "discount rate",
...
export default IconDiscountCircle as IconComponentType;
