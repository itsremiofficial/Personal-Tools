      ...
      {!fill ? (
        ...
        >
          ...
          <path
            ...
            d="M5.66992 12V8.00004C5.66992 5.99004 5.66992 4.33004 8.66992 4.04004"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M19.6699 12V8.00004C19.6699 5.99004 19.6699 4.33004 16.6699 4.04004"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M15.46 4H9.87996C5.45996 4 5.45996 6.35 5.45996 8.42V12.21C5.45996 12.43 5.55996 12.63 5.72996 12.76C5.89996 12.89 6.12996 12.94 6.33996 12.88C6.78996 12.76 7.34996 12.7 8.01996 12.7C8.68996 12.7 8.82996 12.78 9.22996 13.08L10.14 14.04C10.79 14.74 11.72 15.14 12.68 15.14C13.64 15.14 14.56 14.74 15.22 14.04L16.13 13.08C16.53 12.78 16.67 12.7 17.34 12.7C18.01 12.7 18.57 12.76 19.02 12.88C19.23 12.94 19.45 12.89 19.63 12.76C19.8 12.63 19.9 12.42 19.9 12.21V8.42C19.88 6.35 19.88 4 15.46 4Z"
            fill="currentColor"
          />
          <path
            d="M14.9452 6.8C14.6852 6.54 14.2552 6.54 13.9952 6.8L13.3452 7.45V2.67C13.3452 2.3 13.0352 2 12.6652 2C12.2952 2 11.9852 2.3 11.9852 2.67V7.44L11.3452 6.8C11.0852 6.54 10.6552 6.54 10.3952 6.8C10.1352 7.06 10.1352 7.49 10.3952 7.75L12.1952 9.55C12.2052 9.56 12.2052 9.56 12.2152 9.56C12.2752 9.61 12.3352 9.66 12.4152 9.69C12.4952 9.72 12.5852 9.74 12.6752 9.74C12.7652 9.74 12.8452 9.72 12.9352 9.69C13.0152 9.66 13.0952 9.61 13.1552 9.54L14.9552 7.74C15.2052 7.49 15.2052 7.06 14.9452 6.8Z"
            fill="currentColor"
          />
          <path
