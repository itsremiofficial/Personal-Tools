      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.4" : "1"}>
            <path
              d="M17.6699 12C17.6699 14.76 15.4299 17 12.6699 17V7C15.4299 7 17.6699 9.24 17.6699 12Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M12.6699 7V17C9.90992 17 7.66992 14.76 7.66992 12C7.66992 9.24 9.90992 7 12.6699 7Z"
              stroke="currentColor"
              strokeWidth={width}
              strokeLinecap="round"
              strokeLinejoin="round"
...
(IconMask as IconComponentType).keywords = [
  "mask",
  "cloak",
  "masquerade",
  "masque",
...
export default IconMask as IconComponentType;
