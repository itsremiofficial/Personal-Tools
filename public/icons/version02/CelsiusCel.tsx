      ...
      {!fill ? (
        ...
        >
          <path
            ...
            d="M17 15.28C16.01 16.59 14.43 17.43 12.67 17.43C9.66998 17.43 7.22998 15 7.22998 11.99C7.22998 8.98001 9.65998 6.55 12.67 6.55C13.9 6.55 15.03 6.96 15.94 7.64"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M18.0899 11.34C18.7361 11.34 19.2599 10.8162 19.2599 10.17C19.2599 9.52382 18.7361 9 18.0899 9C17.4437 9 16.9199 9.52382 16.9199 10.17C16.9199 10.8162 17.4437 11.34 18.0899 11.34Z"
            stroke="currentColor"
            strokeWidth={width}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M12.67 18.1901C9.25998 18.1901 6.47998 15.4101 6.47998 12.0001C6.47998 8.59006 9.25998 5.81006 12.67 5.81006C14.02 5.81006 15.31 6.24006 16.39 7.05006C16.72 7.30006 16.79 7.77006 16.54 8.10006C16.29 8.43006 15.82 8.50006 15.49 8.25006C14.67 7.64006 13.7 7.31006 12.67 7.31006C10.09 7.31006 7.97998 9.41006 7.97998 12.0001C7.97998 14.5901 10.08 16.6901 12.67 16.6901C14.15 16.6901 15.51 16.0101 16.41 14.8301C16.66 14.5001 17.13 14.4401 17.46 14.6901C17.79 14.9401 17.85 15.4101 17.6 15.7401C16.42 17.2901 14.62 18.1901 12.67 18.1901Z"
            fill="currentColor"
          />
          <path
            d="M18.0899 11.34C18.7361 11.34 19.2599 10.8162 19.2599 10.17C19.2599 9.52383 18.7361 9 18.0899 9C17.4437 9 16.9199 9.52383 16.9199 10.17C16.9199 10.8162 17.4437 11.34 18.0899 11.34Z"
            fill="currentColor"
          />
        </svg>
      ) : (
